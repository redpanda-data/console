...
func (p *SingleClientProvider) GetSchemaRegistryClient(ctx context.Context) (*sr.Client, error) {
	...
	tlsCfg, err := schemaCfg.TLS.TLSConfigWithReloader(ctx, p.logger, hostname)
	if err != nil {
