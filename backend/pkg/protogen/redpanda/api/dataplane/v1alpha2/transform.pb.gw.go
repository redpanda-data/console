...
var filter_TransformService_ListTransforms_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func request_TransformService_ListTransforms_0(ctx context.Context, marshaler runtime.Marshaler, client TransformServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListTransformsRequest
...
func request_TransformService_DeleteTransform_0(ctx context.Context, marshaler runtime.Marshaler, client TransformServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DeleteTransformRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
...
func RegisterTransformServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransformServiceServer) error {
	mux.Handle(http.MethodGet, pattern_TransformService_ListTransforms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/ListTransforms", runtime.WithHTTPPathPattern("/v1alpha2/transforms"))
		if err != nil {
	...
	mux.Handle(http.MethodGet, pattern_TransformService_GetTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/GetTransform", runtime.WithHTTPPathPattern("/v1alpha2/transforms/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_TransformService_GetTransform_0(annotatedContext, mux, outboundMarshaler, w, req, response_TransformService_GetTransform_0{resp.(*GetTransformResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodDelete, pattern_TransformService_DeleteTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/DeleteTransform", runtime.WithHTTPPathPattern("/v1alpha2/transforms/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
// "TransformServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterTransformServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransformServiceClient) error {
	mux.Handle(http.MethodGet, pattern_TransformService_ListTransforms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/ListTransforms", runtime.WithHTTPPathPattern("/v1alpha2/transforms"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodGet, pattern_TransformService_GetTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/GetTransform", runtime.WithHTTPPathPattern("/v1alpha2/transforms/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodDelete, pattern_TransformService_DeleteTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha2.TransformService/DeleteTransform", runtime.WithHTTPPathPattern("/v1alpha2/transforms/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func (m response_TransformService_GetTransform_0) XXX_ResponseBody() interface{} {
	response := m.GetTransformResponse
	return response.Transform
}

var (
	pattern_TransformService_ListTransforms_0  = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha2", "transforms"}, ""))
	pattern_TransformService_GetTransform_0    = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1alpha2", "transforms", "name"}, ""))
	pattern_TransformService_DeleteTransform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1alpha2", "transforms", "name"}, ""))
)
