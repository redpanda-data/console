...
var file_redpanda_api_dataplane_v1alpha2_common_proto_goTypes = []interface{}{
...
func file_redpanda_api_dataplane_v1alpha2_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_redpanda_api_dataplane_v1alpha2_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_redpanda_api_dataplane_v1alpha2_common_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
