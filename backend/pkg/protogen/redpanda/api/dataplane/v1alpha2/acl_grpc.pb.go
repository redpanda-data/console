...
const (
	ACLService_ListACLs_FullMethodName   = "/redpanda.api.dataplane.v1alpha2.ACLService/ListACLs"
	ACLService_CreateACL_FullMethodName  = "/redpanda.api.dataplane.v1alpha2.ACLService/CreateACL"
	ACLService_DeleteACLs_FullMethodName = "/redpanda.api.dataplane.v1alpha2.ACLService/DeleteACLs"
)
...
var ACLService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "redpanda.api.dataplane.v1alpha2.ACLService",
	...
	Metadata: "redpanda/api/dataplane/v1alpha2/acl.proto",
}
