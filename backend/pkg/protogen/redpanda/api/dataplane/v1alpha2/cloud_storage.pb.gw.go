...
func RegisterCloudStorageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CloudStorageServiceServer) error {
	...
	mux.Handle(http.MethodGet, pattern_CloudStorageService_ListMountableTopics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_CloudStorageService_ListMountableTopics_0(annotatedContext, mux, outboundMarshaler, w, req, response_CloudStorageService_ListMountableTopics_0{resp.(*ListMountableTopicsResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_CloudStorageService_ListMountTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_CloudStorageService_ListMountTasks_0(annotatedContext, mux, outboundMarshaler, w, req, response_CloudStorageService_ListMountTasks_0{resp.(*ListMountTasksResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_CloudStorageService_GetMountTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_CloudStorageService_GetMountTask_0(annotatedContext, mux, outboundMarshaler, w, req, response_CloudStorageService_GetMountTask_0{resp.(*GetMountTaskResponse)}, mux.GetForwardResponseOptions()...)
	})
...
func (m response_CloudStorageService_ListMountableTopics_0) XXX_ResponseBody() interface{} {
	response := m.ListMountableTopicsResponse
...
func (m response_CloudStorageService_ListMountTasks_0) XXX_ResponseBody() interface{} {
	response := m.ListMountTasksResponse
...
func (m response_CloudStorageService_GetMountTask_0) XXX_ResponseBody() interface{} {
	response := m.GetMountTaskResponse
