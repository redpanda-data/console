...
type KnowledgeBaseServiceGatewayServer struct {
	v1alpha1.UnimplementedKnowledgeBaseServiceServer
	createKnowledgeBase connect_gateway.UnaryHandler[v1alpha1.CreateKnowledgeBaseRequest, v1alpha1.CreateKnowledgeBaseResponse]
	getKnowledgeBase    connect_gateway.UnaryHandler[v1alpha1.GetKnowledgeBaseRequest, v1alpha1.GetKnowledgeBaseResponse]
	listKnowledgeBases  connect_gateway.UnaryHandler[v1alpha1.ListKnowledgeBasesRequest, v1alpha1.ListKnowledgeBasesResponse]
	updateKnowledgeBase connect_gateway.UnaryHandler[v1alpha1.UpdateKnowledgeBaseRequest, v1alpha1.UpdateKnowledgeBaseResponse]
	deleteKnowledgeBase connect_gateway.UnaryHandler[v1alpha1.DeleteKnowledgeBaseRequest, v1alpha1.DeleteKnowledgeBaseResponse]
}
...
func (s *KnowledgeBaseServiceGatewayServer) CreateKnowledgeBase(ctx context.Context, req *v1alpha1.CreateKnowledgeBaseRequest) (*v1alpha1.CreateKnowledgeBaseResponse, error) {
	return s.createKnowledgeBase(ctx, req)
}

func (s *KnowledgeBaseServiceGatewayServer) GetKnowledgeBase(ctx context.Context, req *v1alpha1.GetKnowledgeBaseRequest) (*v1alpha1.GetKnowledgeBaseResponse, error) {
	return s.getKnowledgeBase(ctx, req)
}

func (s *KnowledgeBaseServiceGatewayServer) ListKnowledgeBases(ctx context.Context, req *v1alpha1.ListKnowledgeBasesRequest) (*v1alpha1.ListKnowledgeBasesResponse, error) {
	return s.listKnowledgeBases(ctx, req)
}

func (s *KnowledgeBaseServiceGatewayServer) UpdateKnowledgeBase(ctx context.Context, req *v1alpha1.UpdateKnowledgeBaseRequest) (*v1alpha1.UpdateKnowledgeBaseResponse, error) {
	return s.updateKnowledgeBase(ctx, req)
}

func (s *KnowledgeBaseServiceGatewayServer) DeleteKnowledgeBase(ctx context.Context, req *v1alpha1.DeleteKnowledgeBaseRequest) (*v1alpha1.DeleteKnowledgeBaseResponse, error) {
...
func RegisterKnowledgeBaseServiceHandlerGatewayServer(mux *runtime.ServeMux, svc KnowledgeBaseServiceHandler, opts ...connect_gateway.HandlerOption) {
	if err := v1alpha1.RegisterKnowledgeBaseServiceHandlerServer(context.TODO(), mux, NewKnowledgeBaseServiceGatewayServer(svc, opts...)); err != nil {
