...
var file_redpanda_api_dataplane_v1alpha1_transform_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_redpanda_api_dataplane_v1alpha1_transform_proto_goTypes = []interface{}{
	...
	(*ListTransformsRequest_Filter)(nil),          // 9: redpanda.api.dataplane.v1alpha1.ListTransformsRequest.Filter
}
var file_redpanda_api_dataplane_v1alpha1_transform_proto_depIdxs = []int32{
	...
	9, // 2: redpanda.api.dataplane.v1alpha1.ListTransformsRequest.filter:type_name -> redpanda.api.dataplane.v1alpha1.ListTransformsRequest.Filter
	...
	3, // 5: redpanda.api.dataplane.v1alpha1.TransformService.ListTransforms:input_type -> redpanda.api.dataplane.v1alpha1.ListTransformsRequest
	5, // 6: redpanda.api.dataplane.v1alpha1.TransformService.GetTransform:input_type -> redpanda.api.dataplane.v1alpha1.GetTransformRequest
	7, // 7: redpanda.api.dataplane.v1alpha1.TransformService.DeleteTransform:input_type -> redpanda.api.dataplane.v1alpha1.DeleteTransformRequest
	4, // 8: redpanda.api.dataplane.v1alpha1.TransformService.ListTransforms:output_type -> redpanda.api.dataplane.v1alpha1.ListTransformsResponse
	6, // 9: redpanda.api.dataplane.v1alpha1.TransformService.GetTransform:output_type -> redpanda.api.dataplane.v1alpha1.GetTransformResponse
	8, // 10: redpanda.api.dataplane.v1alpha1.TransformService.DeleteTransform:output_type -> redpanda.api.dataplane.v1alpha1.DeleteTransformResponse
