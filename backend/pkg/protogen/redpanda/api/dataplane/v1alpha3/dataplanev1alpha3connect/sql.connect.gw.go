...
type SQLServiceGatewayServer struct {
	...
	getSqlConnectionInfo connect_gateway.UnaryHandler[v1alpha3.GetSqlConnectionInfoRequest, v1alpha3.GetSqlConnectionInfoResponse]
}
...
func NewSQLServiceGatewayServer(svc SQLServiceHandler, opts ...connect_gateway.HandlerOption) *SQLServiceGatewayServer {
	return &SQLServiceGatewayServer{
		...
		getSqlConnectionInfo: connect_gateway.NewUnaryHandler(SQLServiceGetSqlConnectionInfoProcedure, svc.GetSqlConnectionInfo, opts...),
	}
}
...
func (s *SQLServiceGatewayServer) GetSqlConnectionInfo(ctx context.Context, req *v1alpha3.GetSqlConnectionInfoRequest) (*v1alpha3.GetSqlConnectionInfoResponse, error) {
	return s.getSqlConnectionInfo(ctx, req)
}
