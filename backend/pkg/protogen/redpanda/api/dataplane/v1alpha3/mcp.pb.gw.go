...
func request_MCPServerService_LintMCPConfig_0(ctx context.Context, marshaler runtime.Marshaler, client MCPServerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LintMCPConfigRequest
	var metadata runtime.ServerMetadata
...
func RegisterMCPServerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MCPServerServiceServer) error {
	...
	mux.Handle("POST", pattern_MCPServerService_LintMCPConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
