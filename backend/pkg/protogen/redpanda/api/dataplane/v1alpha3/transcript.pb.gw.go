...
var filter_TranscriptService_GetTranscript_0 = &utilities.DoubleArray{Encoding: map[string]int{"conversation_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func RegisterTranscriptServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TranscriptServiceServer) error {
	mux.Handle(http.MethodGet, pattern_TranscriptService_ListTranscripts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha3.TranscriptService/ListTranscripts", runtime.WithHTTPPathPattern("/v1alpha3/transcripts"))
		if err != nil {
	...
	mux.Handle(http.MethodGet, pattern_TranscriptService_GetTranscript_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha3.TranscriptService/GetTranscript", runtime.WithHTTPPathPattern("/v1alpha3/transcripts/{conversation_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTranscriptServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TranscriptServiceClient) error {
	mux.Handle(http.MethodGet, pattern_TranscriptService_ListTranscripts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha3.TranscriptService/ListTranscripts", runtime.WithHTTPPathPattern("/v1alpha3/transcripts"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodGet, pattern_TranscriptService_GetTranscript_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1alpha3.TranscriptService/GetTranscript", runtime.WithHTTPPathPattern("/v1alpha3/transcripts/{conversation_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_TranscriptService_ListTranscripts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha3", "transcripts"}, ""))
	pattern_TranscriptService_GetTranscript_0   = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1alpha3", "transcripts", "conversation_id"}, ""))
)
