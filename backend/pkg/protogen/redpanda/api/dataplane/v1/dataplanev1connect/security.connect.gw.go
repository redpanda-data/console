...
type SecurityServiceGatewayServer struct {
	...
	createSchemaRegistryACL  connect_gateway.UnaryHandler[v1.CreateSchemaRegistryACLRequest, v1.CreateSchemaRegistryACLResponse]
...
func NewSecurityServiceGatewayServer(svc SecurityServiceHandler, opts ...connect_gateway.HandlerOption) *SecurityServiceGatewayServer {
	return &SecurityServiceGatewayServer{
		...
		createSchemaRegistryACL:  connect_gateway.NewUnaryHandler(SecurityServiceCreateSchemaRegistryACLProcedure, svc.CreateSchemaRegistryACL, opts...),
...
func (s *SecurityServiceGatewayServer) CreateSchemaRegistryACL(ctx context.Context, req *v1.CreateSchemaRegistryACLRequest) (*v1.CreateSchemaRegistryACLResponse, error) {
	return s.createSchemaRegistryACL(ctx, req)
}
