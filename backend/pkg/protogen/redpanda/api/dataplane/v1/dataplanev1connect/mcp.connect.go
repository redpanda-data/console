...
const (
	...
	// LintMCPConfig RPC.
	MCPServerServiceLintMCPConfigProcedure = "/redpanda.api.dataplane.v1.MCPServerService/LintMCPConfig"
)
...
type MCPServerServiceClient interface {
	...
	LintMCPConfig(context.Context, *connect.Request[v1.LintMCPConfigRequest]) (*connect.Response[v1.LintMCPConfigResponse], error)
}
...
func NewMCPServerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MCPServerServiceClient {
	...
	return &mCPServerServiceClient{
		...
		lintMCPConfig: connect.NewClient[v1.LintMCPConfigRequest, v1.LintMCPConfigResponse](
			httpClient,
...
type mCPServerServiceClient struct {
	...
	lintMCPConfig                   *connect.Client[v1.LintMCPConfigRequest, v1.LintMCPConfigResponse]
}
...
// LintMCPConfig calls redpanda.api.dataplane.v1.MCPServerService.LintMCPConfig.
func (c *mCPServerServiceClient) LintMCPConfig(ctx context.Context, req *connect.Request[v1.LintMCPConfigRequest]) (*connect.Response[v1.LintMCPConfigResponse], error) {
...
func (UnimplementedMCPServerServiceHandler) LintMCPConfig(context.Context, *connect.Request[v1.LintMCPConfigRequest]) (*connect.Response[v1.LintMCPConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.MCPServerService.LintMCPConfig is not implemented"))
}
