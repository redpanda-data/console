...
type MCPServerServiceGatewayServer struct {
	...
	lintMCPConfig                   connect_gateway.UnaryHandler[v1.LintMCPConfigRequest, v1.LintMCPConfigResponse]
}
...
func (s *MCPServerServiceGatewayServer) LintMCPConfig(ctx context.Context, req *v1.LintMCPConfigRequest) (*v1.LintMCPConfigResponse, error) {
