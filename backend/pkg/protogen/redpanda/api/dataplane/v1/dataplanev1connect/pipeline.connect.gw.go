...
type PipelineServiceGatewayServer struct {
	...
	listComponents                 connect_gateway.UnaryHandler[v1.ListComponentsRequest, v1.ListComponentsResponse]
...
func NewPipelineServiceGatewayServer(svc PipelineServiceHandler, opts ...connect_gateway.HandlerOption) *PipelineServiceGatewayServer {
	return &PipelineServiceGatewayServer{
		...
		listComponents:                 connect_gateway.NewUnaryHandler(PipelineServiceListComponentsProcedure, svc.ListComponents, opts...),
...
func (s *PipelineServiceGatewayServer) ListComponents(ctx context.Context, req *v1.ListComponentsRequest) (*v1.ListComponentsResponse, error) {
	return s.listComponents(ctx, req)
}
