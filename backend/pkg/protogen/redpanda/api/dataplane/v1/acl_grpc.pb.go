...
const (
	ACLService_ListACLs_FullMethodName   = "/redpanda.api.dataplane.v1.ACLService/ListACLs"
	ACLService_CreateACL_FullMethodName  = "/redpanda.api.dataplane.v1.ACLService/CreateACL"
	ACLService_DeleteACLs_FullMethodName = "/redpanda.api.dataplane.v1.ACLService/DeleteACLs"
)
...
var ACLService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "redpanda.api.dataplane.v1.ACLService",
	...
	Metadata: "redpanda/api/dataplane/v1/acl.proto",
}
