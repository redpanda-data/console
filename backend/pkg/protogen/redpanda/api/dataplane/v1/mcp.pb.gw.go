...
func RegisterMCPServerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MCPServerServiceServer) error {
	...
	mux.Handle(http.MethodPost, pattern_MCPServerService_LintMCPConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.dataplane.v1.MCPServerService/LintMCPConfig", runtime.WithHTTPPathPattern("/v1/redpanda-connect/mcp-servers:lint-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMCPServerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MCPServerServiceClient) error {
	...
	mux.Handle(http.MethodPost, pattern_MCPServerService_LintMCPConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.dataplane.v1.MCPServerService/LintMCPConfig", runtime.WithHTTPPathPattern("/v1/redpanda-connect/mcp-servers:lint-config"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
