...
func local_request_MonitoringService_ListKafkaConnections_0(ctx context.Context, marshaler runtime.Marshaler, server MonitoringServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq adminv2.ListKafkaConnectionsRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterMonitoringServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MonitoringServiceServer) error {
	mux.Handle(http.MethodGet, pattern_MonitoringService_ListKafkaConnections_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_MonitoringService_ListKafkaConnections_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_MonitoringService_ListKafkaConnections_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterMonitoringServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MonitoringServiceClient) error {
	mux.Handle(http.MethodGet, pattern_MonitoringService_ListKafkaConnections_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_MonitoringService_ListKafkaConnections_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_MonitoringService_ListKafkaConnections_0 = runtime.ForwardResponseMessage
)
