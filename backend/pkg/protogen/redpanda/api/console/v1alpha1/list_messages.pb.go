...
type ListMessagesRequest struct {
	...
	SchemaContext             string                 `protobuf:"bytes,15,opt,name=schema_context,json=schemaContext,proto3" json:"schema_context,omitempty"`                                                                       // Optional Schema Registry context to resolve schema IDs in. Empty uses the topic's redpanda.schema.registry.context, then the default context; "." forces the default context.
