...
func RegisterTransformServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransformServiceServer) error {
	mux.Handle(http.MethodPost, pattern_TransformService_ListTransforms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/ListTransforms", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/ListTransforms"))
		if err != nil {
	...
	mux.Handle(http.MethodPost, pattern_TransformService_GetTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/GetTransform", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/GetTransform"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_TransformService_DeleteTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/DeleteTransform", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/DeleteTransform"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTransformServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransformServiceClient) error {
	mux.Handle(http.MethodPost, pattern_TransformService_ListTransforms_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/ListTransforms", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/ListTransforms"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_TransformService_GetTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/GetTransform", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/GetTransform"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_TransformService_DeleteTransform_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.TransformService/DeleteTransform", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.TransformService/DeleteTransform"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_TransformService_ListTransforms_0  = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.console.v1alpha1.TransformService", "ListTransforms"}, ""))
	pattern_TransformService_GetTransform_0    = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.console.v1alpha1.TransformService", "GetTransform"}, ""))
	pattern_TransformService_DeleteTransform_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.console.v1alpha1.TransformService", "DeleteTransform"}, ""))
)
