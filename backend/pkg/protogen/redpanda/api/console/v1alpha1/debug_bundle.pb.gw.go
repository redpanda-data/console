...
func request_DebugBundleService_GetDebugBundleAdminAPIURLs_0(ctx context.Context, marshaler runtime.Marshaler, client DebugBundleServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDebugBundleAdminAPIURLsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetDebugBundleAdminAPIURLs(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DebugBundleService_GetDebugBundleAdminAPIURLs_0(ctx context.Context, marshaler runtime.Marshaler, server DebugBundleServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDebugBundleAdminAPIURLsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDebugBundleAdminAPIURLs(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDebugBundleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DebugBundleServiceServer) error {
	...
	mux.Handle("POST", pattern_DebugBundleService_GetDebugBundleAdminAPIURLs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.DebugBundleService/GetDebugBundleAdminAPIURLs", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.DebugBundleService/GetDebugBundleAdminAPIURLs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DebugBundleService_GetDebugBundleAdminAPIURLs_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DebugBundleService_GetDebugBundleAdminAPIURLs_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDebugBundleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DebugBundleServiceClient) error {
	...
	mux.Handle("POST", pattern_DebugBundleService_GetDebugBundleAdminAPIURLs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.console.v1alpha1.DebugBundleService/GetDebugBundleAdminAPIURLs", runtime.WithHTTPPathPattern("/redpanda.api.console.v1alpha1.DebugBundleService/GetDebugBundleAdminAPIURLs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DebugBundleService_GetDebugBundleAdminAPIURLs_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DebugBundleService_GetDebugBundleAdminAPIURLs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.console.v1alpha1.DebugBundleService", "GetDebugBundleAdminAPIURLs"}, ""))
)
...
var (
	...
	forward_DebugBundleService_GetDebugBundleAdminAPIURLs_0 = runtime.ForwardResponseMessage
)
