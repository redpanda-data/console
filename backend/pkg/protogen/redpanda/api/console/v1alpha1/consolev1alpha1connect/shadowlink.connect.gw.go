...
type ShadowLinkServiceGatewayServer struct {
	...
	getShadowLink    connect_gateway.UnaryHandler[v2.GetShadowLinkRequest, v1alpha1.GetShadowLinkResponse]
	listShadowLinks  connect_gateway.UnaryHandler[v2.ListShadowLinksRequest, v1alpha1.ListShadowLinksResponse]
...
func (s *ShadowLinkServiceGatewayServer) GetShadowLink(ctx context.Context, req *v2.GetShadowLinkRequest) (*v1alpha1.GetShadowLinkResponse, error) {
	return s.getShadowLink(ctx, req)
}

func (s *ShadowLinkServiceGatewayServer) ListShadowLinks(ctx context.Context, req *v2.ListShadowLinksRequest) (*v1alpha1.ListShadowLinksResponse, error) {
