...
const (
	...
	TopicServiceName = "redpanda.api.console.v1alpha1.TopicService"
)
...
const (
	...
	TopicServiceListTopicsProcedure = "/redpanda.api.console.v1alpha1.TopicService/ListTopics"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	topicServiceServiceDescriptor          = v1alpha1.File_redpanda_api_console_v1alpha1_topic_proto.Services().ByName("TopicService")
	topicServiceListTopicsMethodDescriptor = topicServiceServiceDescriptor.Methods().ByName("ListTopics")
)

// TopicServiceClient is a client for the redpanda.api.console.v1alpha1.TopicService service.
...
// NewTopicServiceClient constructs a client for the redpanda.api.console.v1alpha1.TopicService
...
// ListTopics calls redpanda.api.console.v1alpha1.TopicService.ListTopics.
...
// TopicServiceHandler is an implementation of the redpanda.api.console.v1alpha1.TopicService
// service.
...
func NewTopicServiceHandler(svc TopicServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.console.v1alpha1.TopicService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTopicServiceHandler) ListTopics(context.Context, *connect.Request[v1alpha1.ListTopicsRequest]) (*connect.Response[v1alpha1.ListTopicsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.console.v1alpha1.TopicService.ListTopics is not implemented"))
}
