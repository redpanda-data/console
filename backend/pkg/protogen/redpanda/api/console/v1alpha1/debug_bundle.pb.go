...
func (SCRAMAuth_Mechanism) EnumDescriptor() ([]byte, []int) {
	return file_redpanda_api_console_v1alpha1_debug_bundle_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *OIDCAuth) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type CreateDebugBundleRequest struct {
	...
	// Optional.
	PartitionIds []int32 `protobuf:"varint,10,rep,packed,name=partition_ids,json=partitionIds,proto3" json:"partition_ids,omitempty"`
}
...
func (x *CreateDebugBundleRequest) GetOidc() *OIDCAuth {
	if x, ok := x.GetAuthentication().(*CreateDebugBundleRequest_Oidc); ok {
		return x.Oidc
	}
	return nil
}
...
func (x *CreateDebugBundleRequest) GetPartitionIds() []int32 {
	if x != nil {
...
type CreateDebugBundleRequest_Oidc struct {
	Oidc *OIDCAuth `protobuf:"bytes,1,opt,name=oidc,proto3,oneof"`
}

type CreateDebugBundleRequest_Scram struct {
	Scram *SCRAMAuth `protobuf:"bytes,2,opt,name=scram,proto3,oneof"`
}

func (*CreateDebugBundleRequest_Oidc) isCreateDebugBundleRequest_Authentication() {}
...
var file_redpanda_api_console_v1alpha1_debug_bundle_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4f, 0x49, 0x44, 0x43, 0x41, 0x75, 0x74, 0x68, 0x48,
	0x00, 0x52, 0x04, 0x6f, 0x69, 0x64, 0x63, 0x12, 0x40, 0x0a, 0x05, 0x73, 0x63, 0x72, 0x61, 0x6d,
	...
	,
	...
	0x03, 0x28, 0x05, 0x52, 0x09, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0xfb,
	0x02, 0x0a, 0x11, 0x44, 0x65, 0x62, 0x75, 0x67, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x53, 0x74,
	...
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x06, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x64, 0x65,
	0x72, 0x72, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x64, 0x65, 0x72, 0x72,
	...
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x22, 0x6c, 0x0a, 0x1c,
	0x47, 0x65, 0x74, 0x44, 0x65, 0x62, 0x75, 0x67, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x08,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30,
	...
	0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x22, 0x50, 0x0a, 0x18, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52,
	...
	0x05, 0x52, 0x09, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x5f, 0x0a, 0x19,
	...
	0x6c, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a,
	0x08, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x72, 0x6f,
	0x6b, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x09, 0x62,
	0x72, 0x6f, 0x6b, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x63, 0x0a, 0x1d, 0x44, 0x65, 0x6c, 0x65,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0xfc, 0x01, 0x0a, 0x0f, 0x42, 0x75, 0x6e,
	...
	0x42, 0x5f, 0x49, 0x44, 0x10, 0x03, 0x12, 0x29, 0x0a, 0x25, 0x42, 0x55, 0x4e, 0x44, 0x4c, 0x45,
	0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x43,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x32, 0xd5, 0x04, 0x0a, 0x12, 0x44, 0x65, 0x62, 0x75,
	0x67, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x88,
	...
	0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67, 0x42, 0x75, 0x6e,
	0x64, 0x6c, 0x65, 0x12, 0x37, 0x2e, 0x72, 0x65, 0x64, 0x70, 0x61, 0x6e, 0x64, 0x61, 0x2e, 0x61,
	...
	0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x38, 0x2e, 0x72,
...
var file_redpanda_api_console_v1alpha1_debug_bundle_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_redpanda_api_console_v1alpha1_debug_bundle_proto_goTypes = []interface{}{
	...
	(*OIDCAuth)(nil),                      // 3: redpanda.api.console.v1alpha1.OIDCAuth
	...
	(*DeleteDebugBundleRequest)(nil),      // 10: redpanda.api.console.v1alpha1.DeleteDebugBundleRequest
	(*DeleteDebugBundleResponse)(nil),     // 11: redpanda.api.console.v1alpha1.DeleteDebugBundleResponse
...
var file_redpanda_api_console_v1alpha1_debug_bundle_proto_depIdxs = []int32{
	...
	3,  // 1: redpanda.api.console.v1alpha1.CreateDebugBundleRequest.oidc:type_name -> redpanda.api.console.v1alpha1.OIDCAuth
	4,  // 2: redpanda.api.console.v1alpha1.CreateDebugBundleRequest.scram:type_name -> redpanda.api.console.v1alpha1.SCRAMAuth
	15, // 3: redpanda.api.console.v1alpha1.CreateDebugBundleRequest.logs_since:type_name -> google.protobuf.Timestamp
	15, // 4: redpanda.api.console.v1alpha1.CreateDebugBundleRequest.logs_until:type_name -> google.protobuf.Timestamp
	...
	15, // 6: redpanda.api.console.v1alpha1.DebugBundleStatus.created_at:type_name -> google.protobuf.Timestamp
	8,  // 7: redpanda.api.console.v1alpha1.GetDebugBundleStatusResponse.statuses:type_name -> redpanda.api.console.v1alpha1.DebugBundleStatus
	14, // 8: redpanda.api.console.v1alpha1.DeleteDebugBundleResponse.errors:type_name -> redpanda.api.console.v1alpha1.BundleError
	...
	5,  // 11: redpanda.api.console.v1alpha1.DebugBundleService.CreateDebugBundle:input_type -> redpanda.api.console.v1alpha1.CreateDebugBundleRequest
	7,  // 12: redpanda.api.console.v1alpha1.DebugBundleService.GetDebugBundleStatus:input_type -> redpanda.api.console.v1alpha1.GetDebugBundleStatusRequest
	10, // 13: redpanda.api.console.v1alpha1.DebugBundleService.DeleteDebugBundle:input_type -> redpanda.api.console.v1alpha1.DeleteDebugBundleRequest
	12, // 14: redpanda.api.console.v1alpha1.DebugBundleService.DeleteDebugBundleFile:input_type -> redpanda.api.console.v1alpha1.DeleteDebugBundleFileRequest
	6,  // 15: redpanda.api.console.v1alpha1.DebugBundleService.CreateDebugBundle:output_type -> redpanda.api.console.v1alpha1.CreateDebugBundleResponse
	9,  // 16: redpanda.api.console.v1alpha1.DebugBundleService.GetDebugBundleStatus:output_type -> redpanda.api.console.v1alpha1.GetDebugBundleStatusResponse
	11, // 17: redpanda.api.console.v1alpha1.DebugBundleService.DeleteDebugBundle:output_type -> redpanda.api.console.v1alpha1.DeleteDebugBundleResponse
	13, // 18: redpanda.api.console.v1alpha1.DebugBundleService.DeleteDebugBundleFile:output_type -> redpanda.api.console.v1alpha1.DeleteDebugBundleFileResponse
...
func file_redpanda_api_console_v1alpha1_debug_bundle_proto_init() {
	...
	file_redpanda_api_console_v1alpha1_debug_bundle_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*CreateDebugBundleRequest_Oidc)(nil),
