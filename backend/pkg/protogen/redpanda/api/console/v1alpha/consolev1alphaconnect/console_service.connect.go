...
const (
	...
	// PublishMessage RPC.
	ConsoleServicePublishMessageProcedure = "/redpanda.api.console.v1alpha.ConsoleService/PublishMessage"
)
...
type ConsoleServiceClient interface {
	...
	PublishMessage(context.Context, *connect.Request[v1alpha.PublishMessageRequest]) (*connect.Response[v1alpha.PublishMessageResponse], error)
}
...
func NewConsoleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConsoleServiceClient {
	...
	return &consoleServiceClient{
		...
		publishMessage: connect.NewClient[v1alpha.PublishMessageRequest, v1alpha.PublishMessageResponse](
			httpClient,
...
type consoleServiceClient struct {
	...
	publishMessage *connect.Client[v1alpha.PublishMessageRequest, v1alpha.PublishMessageResponse]
}
...
// PublishMessage calls redpanda.api.console.v1alpha.ConsoleService.PublishMessage.
func (c *consoleServiceClient) PublishMessage(ctx context.Context, req *connect.Request[v1alpha.PublishMessageRequest]) (*connect.Response[v1alpha.PublishMessageResponse], error) {
...
func (UnimplementedConsoleServiceHandler) PublishMessage(context.Context, *connect.Request[v1alpha.PublishMessageRequest]) (*connect.Response[v1alpha.PublishMessageResponse], error) {
