...
var file_redpanda_api_common_v1_errordetails_proto_goTypes = []interface{}{
...
func file_redpanda_api_common_v1_errordetails_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_redpanda_api_common_v1_errordetails_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_redpanda_api_common_v1_errordetails_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_redpanda_api_common_v1_errordetails_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
