...
var file_redpanda_api_common_v1_linthint_proto_goTypes = []interface{}{
...
func file_redpanda_api_common_v1_linthint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_redpanda_api_common_v1_linthint_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
