...
func (srm *schemaRegistryMapper) listACLFilterToDescribeACLSR(filter *v1.ListACLsRequest_Filter) []rpsr.ACL {
	...
	if rt := filter.GetResourceType(); rt == v1.ACL_RESOURCE_TYPE_REGISTRY || rt == v1.ACL_RESOURCE_TYPE_SUBJECT || rt == v1.ACL_RESOURCE_TYPE_ANY {
		...
		return []rpsr.ACL{
			{
				...
				ResourceType: srm.protoResourceTypeToSR(rt),
