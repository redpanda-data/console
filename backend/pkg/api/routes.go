...
import (
	...
	rpconnect "github.com/redpanda-data/console/backend/pkg/api/connect/service/rpconnect/v1alpha2"
...
func (api *API) setupConnectWithGRPCGateway(r chi.Router) {
	...
	transformSvcPath, transformSvcHandler := dataplanev1alpha2connect.NewTransformServiceHandler(
		...
		connect.WithInterceptors(hookOutput.Interceptors...))
	kafkaConnectPath, kafkaConnectHandler := dataplanev1alpha2connect.NewKafkaConnectServiceHandler(
