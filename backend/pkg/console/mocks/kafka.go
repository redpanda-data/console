...
//
//	mockgen -destination=./mocks/kafka.go -package=mocks github.com/redpanda-data/console/backend/pkg/console IListMessagesProgress
//
...
func (m *MockIListMessagesProgress) OnMessage(arg0 *console.TopicMessage) {
	m.ctrl.T.Helper()
