...
export type TimestampDisplayFormat =
	| "default"
	| "unixTimestamp"
	| "onlyDate"
	| "onlyTime"
...
export class TopicDetailsSettings {
	...
	@observable favConfigEntries: string[] = [
		"cleanup.policy",
		"segment.bytes",
		"segment.ms",
	];
	...
	@observable previewTagsCaseSensitive: "caseSensitive" | "ignoreCase" =
		"ignoreCase";
	...
	@observable produceRecordEncoding = PayloadEncoding.TEXT as
		| PayloadEncoding
		| "base64";
...
window.addEventListener("storage", (e) => {
	...
	try {
		...
		console.error("error applying settings update from another tab", {
			storageEvent: e,
			error: err,
		});
	}
