...
import { CreateDebugBundleRequest, CreateDebugBundleResponse, DebugBundleStatus, DebugBundleStatus_Status, GetClusterHealthResponse, GetDebugBundleStatusResponse_DebugBundleBrokerStatus, UnhealthyReason } from '../protogen/redpanda/api/console/v1alpha1/debug_bundle_pb';
