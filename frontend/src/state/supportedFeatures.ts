...
export class Feature {
	static readonly ClusterConfig: FeatureEntry = {
		endpoint: "/api/cluster/config",
		method: "GET",
	};
	static readonly ConsumerGroups: FeatureEntry = {
		endpoint: "/api/consumer-groups",
		method: "GET",
	};
	static readonly GetReassignments: FeatureEntry = {
	...
	static readonly PatchGroup: FeatureEntry = {
		endpoint: "/api/consumer-groups/{groupId}",
		method: "PATCH",
	};
	static readonly DeleteGroup: FeatureEntry = {
		endpoint: "/api/consumer-groups/{groupId}",
		method: "DELETE",
	};
	...
	static readonly DeleteRecords: FeatureEntry = {
		endpoint: "/api/topics/{topicName}/records",
		method: "DELETE",
	};
	static readonly GetQuotas: FeatureEntry = {
		endpoint: "/api/quotas",
		method: "GET",
	};
	static readonly CreateUser: FeatureEntry = {
		endpoint: "/api/users",
		method: "POST",
	};
	static readonly DeleteUser: FeatureEntry = {
		endpoint: "/api/users",
		method: "DELETE",
	};
...
export function isSupported(f: FeatureEntry): boolean {
	...
	for (const e of c.endpoints)
		if (e.method == f.method)
			if (e.endpoint == f.endpoint) return e.isSupported;
