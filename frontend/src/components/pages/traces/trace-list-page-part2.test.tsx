...
import { REGEX_SERVICE, REGEX_STATUS, createMockTrace, createMockTraceSummary, renderTraceListPage } from './trace-list-page.test-helpers';
...
describe('TraceListPage - Filtering & Expansion (Part 2/3)', () => {
