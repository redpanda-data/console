    ...
    return (
      <PageContent>
        ...
        <Flex flexDirection="column" gap={3}>
          ...
          <FormField
            label="Tasks"
            description="One task is equivalent to 0.1 CPU and 400 MB of memory. This is enough to experiment with low-volume pipelines. For pipelines that include AI components, one task is equivalent to 1 GPU. This can have cost implications."
            w={500}
          >
            <NumberInput
              value={this.tasks}
