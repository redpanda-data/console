...
export function ScrollShadow({ className, contentClassName, children }: ScrollShadowProps) {
  ...
  return (
    <div className={cn('relative min-h-0 flex-1 overflow-y-auto', className)} ref={containerRef}>
      ...
      >
        <div className="absolute inset-x-0 top-0 h-3 bg-gradient-to-b from-static-dark/10 to-transparent dark:from-static-dark/40" />
      </div>
      ...
      >
        <div className="absolute inset-x-0 bottom-0 h-3 bg-gradient-to-t from-static-dark/10 to-transparent dark:from-static-dark/40" />
      </div>
    </div>
  );
}
