...
export function ViewDetails({ pipeline, onDelete, isDeleting }: ViewDetailsProps) {
  ...
  const visibleTags = Object.entries(pipeline.tags).filter(([k]) => !isSystemTag(k));
        ...
        <div>
          ...
          <Card variant="ghost">
            ...
            <CardContent className="flex flex-col gap-4">
              <Text>
                Deleting this pipeline is permanent and cannot be undone. Any secrets or resources used by this pipeline
