...
Element.prototype.scrollIntoView = rstest.fn();
...
describe('AIAgentsListPage', () => {
  test('should list all AI agents', async () => {
    ...
    const listAIAgentsMock = rstest.fn().mockReturnValue(listAIAgentsResponse);
    const listMCPServersMock = rstest.fn().mockReturnValue(listMCPServersResponse);
  ...
  test('should delete an AI agent from the list', async () => {
    ...
    const listAIAgentsMock = rstest.fn().mockReturnValue(listAIAgentsResponse);
    const listMCPServersMock = rstest.fn().mockReturnValue(listMCPServersResponse);
    const deleteAIAgentMock = rstest.fn().mockReturnValue(create(DeleteAIAgentResponseSchema, {}));
  ...
  test('should stop a running AI agent from the list', async () => {
    ...
    const listAIAgentsMock = rstest.fn().mockReturnValue(listAIAgentsResponse);
    const listMCPServersMock = rstest.fn().mockReturnValue(listMCPServersResponse);
    const stopAIAgentMock = rstest.fn().mockReturnValue(
  ...
  test('should start a stopped AI agent from the list', async () => {
    ...
    const listAIAgentsMock = rstest.fn().mockReturnValue(listAIAgentsResponse);
    const listMCPServersMock = rstest.fn().mockReturnValue(listMCPServersResponse);
    const startAIAgentMock = rstest.fn().mockReturnValue(
  ...
  test('should display loading state when fetching agents', async () => {
    const listAIAgentsMock = rstest.fn().mockImplementation(
      () =>
        new Promise((resolve) => {
          setTimeout(() => {
            resolve(
    ...
    const listMCPServersMock = rstest.fn().mockReturnValue(
