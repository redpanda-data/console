	...
	return (
		<form
			onSubmit={async (e) => {
				...
				const content = (
					state.showFileUpload ? state.licenseFile : state.license
				) as string;
				...
				{this.success ? (
								...
								<Flex flexDirection="column" gap={4}>
									<Box>
										<Text fontWeight="normal">
											A restart will be needed to use Redpanda Console's
											enterprise features.
										</Text>
										<Text fontWeight="normal">
											Enterprise features in your Redpanda cluster will be
					...
					<>
						...
						<Text>
							...
							to request a license. To see a list of what is available with
							Redpanda Enterprise, check{" "}
							<Link
