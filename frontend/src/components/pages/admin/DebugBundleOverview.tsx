...
const StatusIcons: Record<DebugBundleStatus_Status, React.ReactElement> = {
	[DebugBundleStatus_Status.UNSPECIFIED]: (
		<MdError color={colors.green} size={16} />
	),
	[DebugBundleStatus_Status.SUCCESS]: (
		<MdCheckCircle color={colors.green} size={16} />
	),
	[DebugBundleStatus_Status.RUNNING]: <Spinner size="sm" />,
	[DebugBundleStatus_Status.ERROR]: (
		<MdError color={colors.debugRed} size={16} />
	),
	[DebugBundleStatus_Status.EXPIRED]: (
		<MdError color={colors.debugRed} size={16} />
	),
};

const DebugBundleOverview: FC<{
