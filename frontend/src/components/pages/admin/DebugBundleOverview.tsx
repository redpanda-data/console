...
import { DebugBundleStatus_Status, GetDebugBundleStatusResponse_DebugBundleBrokerStatus } from '../../../protogen/redpanda/api/console/v1alpha1/debug_bundle_pb';
...
const DebugBundleOverview: FC<{ statuses: GetDebugBundleStatusResponse_DebugBundleBrokerStatus[] }> = ({statuses}) => {
    useEffect(() => {
                    ...
                    <Flex gap={3} alignItems="center">
                        ...
                        {status.value.case === 'error' && <>
                            ...
                            <Stack spacing={0.5}>
                                ...
                                <Text color="gray.500" fontSize="sm">{status.value.value.message}</Text>
                            </Stack>
                        </>}
                    </Flex>
                </ListItem>))}
