...
//
type ValueAndChangeCallback = {
	value: number | null;
	onChange: (x: number | null) => void;
};
type BindableSettings = Pick<
	typeof uiSettings.reassignment,
	"maxReplicationTraffic"
>;
...
export class BandwidthSlider extends Component<
	ValueAndChangeCallback | { settings: BindableSettings }
> {
