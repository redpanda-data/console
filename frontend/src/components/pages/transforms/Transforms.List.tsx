...
class TransformsList extends PageComponent<{}> {
    ...
    render() {
        ...
        const filteredTransforms = (transformsApi.transforms ?? [])
            .filter(u => {
        ...
        return (
            <PageContent>
                ...
                <Stack direction="row" mb="6">
                    ...
                    <Button variant="outline" isDisabled>Export metrics</Button>
                </Stack>
                ...
                <Section>
                    ...
                    <DataTable<TransformMetadata>
                        ...
                        columns={[
                            ...
                            {
                                header: 'Input topic', accessorKey: 'inputTopicName',
                            },
                            {
                                header: 'Output topics', cell: ({ row: { original: r } }) => {
                                    return <Stack>
                                        {r.outputTopicNames.map(n => <Box key={n}>{n}</Box>)}
                                    </Stack>
                                }
                            },
                            {
