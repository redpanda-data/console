...
const ResourceTypeSelection = ({
  ...
  return (
    <span className="inline-flex h-10 items-center justify-center rounded-md bg-gray-100 p-1 text-gray-600">
      {/*TODO: Add tooltip with <p>Only one cluster rule is allowed. A cluster rule already exists.</p>*/}
      {buttons.map(({ name, resourceType, disabled }) => (
        <Button
          ...
          <CardField>
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              <Input
                ...
                className="flex-1 border-gray-300 focus:border-gray-500 focus:ring-gray-500 col-span-3"
...
export default function CreateACL({
  ...
  const schemaRegistryEnabled = Features.schemaRegistryACLService;
  ...
  useEffect(() => {
    if (sharedConfig.principal.split(':')[0]) {
      setPrincipalError('');
    }
              ...
              <div className="sticky top-20">
                <div className="mb-2 flex justify-end gap-2 h-10">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (!sharedConfig.principal.split(':')[1]) {
