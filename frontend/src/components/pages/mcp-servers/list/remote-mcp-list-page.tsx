...
import {
	MCPDeleteHandler,
	type MCPDeleteHandlerRef,
} from "./mcp-delete-handler";
...
export const createColumns = (
	...
	},
	{
		accessorKey: "url",
		header: ({ column }) => (
			<DataTableColumnHeader column={column} title="Server URL" />
		),
		cell: ({ row }) => {
			...
			return (
				<Tooltip>
					<TooltipTrigger asChild>
						<Text
							className="cursor-help font-mono text-muted-foreground"
							variant="small"
						>
							{truncatedUrl}
						</Text>
...
const RemoteMCPListPageContent = ({
	...
	deleteHandlerRef: React.RefObject<MCPDeleteHandlerRef>;
}) => {
	...
	const { mutateAsync: deleteMCPServer, isPending: isDeletingServer } =
		useDeleteMCPServerMutation();
