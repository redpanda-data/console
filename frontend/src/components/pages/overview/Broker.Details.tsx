				...
				<PageContent>
					<Section py={4}>
						<Flex>
							...
							<Statistic
								title="Role"
								value={broker.isController ? "Controller" : "Follower"}
							/>
							<Statistic
								title="Storage"
								value={prettyBytesOrNA(broker.totalLogDirSizeBytes!)}
							/>
...
const DetailsDisplaySettings = observer(() => (
	<div
		style={{ marginLeft: "1px", marginBottom: "1em" }}
		className="brokerConfigViewSettings"
	>
		<Flex gap="2rem">
			<OptionGroup
				label="Formatting"
