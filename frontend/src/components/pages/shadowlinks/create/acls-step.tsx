      ...
      <Card size="full">
        ...
        <CardContent>
          ...
          {aclFiltersFields.map((field, index) => (
            <Card className="border w-full" key={field.id} size="full">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <h5 className="font-medium text-sm border-b pb-3">Resource Filter</h5>
                ...
                <div>
                  <h5 className="font-medium text-sm border-b pb-3">Access Filter</h5>
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-4 mt-8">
                    <FormField
                      control={form.control}
