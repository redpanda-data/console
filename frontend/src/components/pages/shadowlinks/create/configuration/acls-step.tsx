				...
				<CardHeader>
					...
					<CardAction>
						<CollapsibleTrigger asChild>
							<Button
								className="w-fit p-0"
								data-testid="acls-toggle-button"
								size="sm"
								variant="ghost"
							>
								<ChevronDown
					...
					<Tabs onValueChange={handleModeChange} value={aclsMode}>
						...
						<CollapsibleContent>
							<TabsContent value="all">
								<Alert>
									<AlertDescription>
										All ACLs from the source cluster will be synchronized to the
										destination cluster.
									</AlertDescription>
								</Alert>
							</TabsContent>
													...
													<div className="grid grid-cols-1 items-start gap-8 md:grid-cols-4">
														<FormField
															...
															render={({ field: resourceTypeField }) => (
																<FormItem
																	data-testid={`acl-filter-${index}-resource-type`}
																>
																	<FormLabel>Resource type</FormLabel>
																	<Select
																		onValueChange={(v) =>
																			resourceTypeField.onChange(Number(v))
																		}
																		value={
																	...
																	>
																		...
																		<SelectContent>
																			...
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_TOPIC,
																				)}
																			>
																				Topic
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_GROUP,
																				)}
																			>
																				Consumer Group
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_CLUSTER,
																				)}
																			>
																				Cluster
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_TXN_ID,
																				)}
																			>
																				Transaction ID
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_SR_SUBJECT,
																				)}
																			>
																			...
																			<SelectItem
																				value={String(
																					ACLResource.ACL_RESOURCE_SR_REGISTRY,
																				)}
																			>
																				Schema Registry
																			</SelectItem>
														...
														<FormField
															...
															render={({ field: resourcePatternField }) => (
																<FormItem>
																	...
																	<Select
																		onValueChange={(v) =>
																			resourcePatternField.onChange(Number(v))
																		}
																		value={
																	...
																	>
																		...
																		<SelectContent>
																			...
																			<SelectItem
																				value={String(
																					ACLPattern.ACL_PATTERN_LITERAL,
																				)}
																			>
																				Literal
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLPattern.ACL_PATTERN_PREFIXED,
																				)}
																			>
																				Prefixed
																			</SelectItem>
														...
														<FormField
															...
															render={({ field: operationField }) => (
																<FormItem>
																	...
																	<Select
																		onValueChange={(v) =>
																			operationField.onChange(Number(v))
																		}
																		value={
																			operationField.value !== undefined
																				? String(operationField.value)
																				: undefined
																		}
																	>
																		<FormControl>
																		...
																		<SelectContent>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_ANY,
																				)}
																			>
																				Any
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_READ,
																				)}
																			>
																				Read
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_WRITE,
																				)}
																			>
																				Write
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_CREATE,
																				)}
																			>
																				Create
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_REMOVE,
																				)}
																			>
																				Remove
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_ALTER,
																				)}
																			>
																				Alter
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_DESCRIBE,
																				)}
																			>
																				Describe
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_CLUSTER_ACTION,
																				)}
																			>
																				Cluster Action
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_DESCRIBE_CONFIGS,
																				)}
																			>
																				Describe Configs
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_ALTER_CONFIGS,
																				)}
																			>
																				Alter Configs
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLOperation.ACL_OPERATION_IDEMPOTENT_WRITE,
																				)}
																			>
																				Idempotent Write
																			</SelectItem>
														...
														<FormField
															...
															render={({ field: permissionTypeField }) => (
																<FormItem>
																	...
																	<Select
																		onValueChange={(v) =>
																			permissionTypeField.onChange(Number(v))
																		}
																		value={
																	...
																	>
																		...
																		<SelectContent>
																			<SelectItem
																				value={String(
																					ACLPermissionType.ACL_PERMISSION_TYPE_ANY,
																				)}
																			>
																				Any
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLPermissionType.ACL_PERMISSION_TYPE_ALLOW,
																				)}
																			>
																				Allow
																			</SelectItem>
																			<SelectItem
																				value={String(
																					ACLPermissionType.ACL_PERMISSION_TYPE_DENY,
																				)}
																			>
																				Deny
																			</SelectItem>
