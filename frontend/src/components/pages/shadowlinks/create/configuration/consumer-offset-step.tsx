				...
				<CardHeader>
					...
					<CardAction>
						<CollapsibleTrigger asChild>
							<Button
								className="w-fit p-0"
								data-testid="consumers-toggle-button"
								size="sm"
								variant="ghost"
							>
								<ChevronDown
					...
					<Tabs onValueChange={handleModeChange} value={consumersMode}>
						...
						<CollapsibleContent>
							<TabsContent value="all">
								<Alert>
									<AlertDescription>
										All consumer groups from the source cluster will be
										synchronized to the destination cluster.
									</AlertDescription>
								</Alert>
							</TabsContent>
							...
							<TabsContent value="specify">
								<div
									className="space-y-4"
									data-testid="consumers-filters-container"
								>
									{fields.map((field, index) => (
										<FilterItem
											control={control}
