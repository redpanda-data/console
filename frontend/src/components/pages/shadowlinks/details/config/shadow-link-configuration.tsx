...
export const ShadowLinkConfiguration = ({
	shadowLink,
}: ShadowLinkConfigurationProps) => (
	<Tabs defaultValue="all">
		<TabsList testId="configuration-subtabs">
			...
			<TabsTrigger
				testId="topic-config-replication-tab"
				value="topic-config-replication"
				variant="underline"
			>
		...
		<TabsContents className="w-2/3">
			...
			<TabsContent
				testId="topic-config-replication-content"
				value="topic-config-replication"
			>
				<ConfigurationTopicReplication shadowLink={shadowLink} />
			</TabsContent>
