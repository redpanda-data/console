...
import { useFullscreenOverlay } from 'hooks/use-fullscreen-overlay';
...
export function SqlWorkspace({ sqlRole: sqlRoleProp }: SqlWorkspaceProps) {
  ...
  const { mode, toggleMode, attachOverlay } = useFullscreenOverlay({
    storageKey: STUDIO_MODE_KEY,
    onAttach: setStudioPageHeader,
  });
