...
import { useAddTopicFormData, useAddUserFormData } from '../../../../state/onboarding-wizard/state';
import type { StepSubmissionResult } from '../types';
import { type AddUserFormData, addUserFormSchema, saslMechanisms } from '../types/forms';
...
export const AddUserStep = forwardRef<AddUserStepRef, AddUserStepProps>(({ usersList }, ref) => {
  const { data: persistedUserData, setData: setUserFormData } = useAddUserFormData();
