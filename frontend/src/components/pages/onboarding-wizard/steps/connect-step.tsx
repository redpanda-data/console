...
const ConnectByAdditionalConnection = ({
	connection,
	dataType,
}: {
			...
			<Card size="full">
				<CardHeader className="flex flex-row items-center gap-4">
					...
					<div className="flex flex-col">
						<Heading level={2}>Connect to {connection.name}</Heading>
						<Text variant="muted">
							{dataType === "source"
								? "Send your data to your cluster"
								: "Read your data from your cluster"}
						</Text>
					</div>
				</CardHeader>
				<CardContent>
					Follow the documentation below to configure your {connection.name}{" "}
					connection.
				</CardContent>
			</Card>
			...
			{isLoading ? (
				...
				<Card size="full">
					<CardContent className="text-center py-8">
						<Text variant="muted">
							Unable to load documentation. Please check the connection URLs.
						</Text>
				...
				<div className="flex flex-col gap-6">
					...
					{!primaryContent && !secondaryContent && (
						<Card size="full">
							<CardContent className="text-center py-8">
								<Text variant="muted">
									No documentation content available for this connection.
								</Text>
							</CardContent>
						</Card>
					)}
