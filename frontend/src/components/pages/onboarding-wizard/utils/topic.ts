...
export const resetToDefaults = (form: UseFormReturn<AddTopicFormData>) => {
  form.setValue('partitions', FORM_DEFAULTS.partitions);
  form.setValue('replicationFactor', FORM_DEFAULTS.replicationFactor);
  form.setValue('retentionTimeMs', FORM_DEFAULTS.retentionTimeMs);
  form.setValue('retentionTimeUnit', FORM_DEFAULTS.retentionTimeUnit);
  form.setValue('retentionSize', FORM_DEFAULTS.retentionSize);
  form.setValue('retentionSizeUnit', FORM_DEFAULTS.retentionSizeUnit);
};
...
export const parseTopicConfigFromExisting = (
  ...
  return {
    ...
    partitions: topic.partitionCount || FORM_DEFAULTS.partitions,
    replicationFactor: topic.replicationFactor || FORM_DEFAULTS.replicationFactor,
    retentionTimeMs,
    retentionTimeUnit,
    retentionSize,
    retentionSizeUnit,
