...
describe('KnowledgeBaseCreateFormSchema', () => {
  describe('postgresTable validation', () => {
    const validBaseData = {
      ...
      credentialChoice: 'manual' as const,
    ...
    it('should accept table names starting with a letter', () => {
    ...
    it('should accept table names with letters, numbers, and underscores', () => {
    ...
    it('should reject table names starting with an underscore', () => {
      const result = KnowledgeBaseCreateFormSchema.safeParse({
        ...validBaseData,
