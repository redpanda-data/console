        ...
        const copyDropdown = (record: TopicMessage) => (
            <NoClipboardPopover>
                <Menu>
                    ...
                    <Menu.Item disabled={!isClipboardAvailable} key="1" onClick={() => this.copyMessage(record, 'rawValue')}>
                        Copy Value (Raw)
                    </Menu.Item>
                    <Menu.Item disabled={!isClipboardAvailable} key="2" onClick={() => this.copyMessage(record, 'jsonValue')}>
                        Copy Value (JSON Format)
                    </Menu.Item>
                    <Menu.Item disabled={!isClipboardAvailable} key="4" onClick={() => this.copyMessage(record, 'timestamp')}>
