...
import type { TopicAction, TopicMessage } from '../../../../state/rest-interfaces';
import { Feature, isSupported } from '../../../../state/supported-features';

/**
 * Converts a TopicMessage to a JSON string representation
 */
export function getMessageAsString(value: string | TopicMessage): string {
...
/**
 * Converts a payload to a string representation
 */
...
/**
 * Highlights control characters in a string with visual representation
 */
export function highlightControlChars(str: string, maxLength?: number): ReactNode[] {
...
/**
 * Gets the name of a control character by its code
 */
