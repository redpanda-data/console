import { CodeEditor } from '@/components/redpanda-ui/code-editor';
...
export const NodeMarkdown = ({ content }: NodeMarkdownProps) => {
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        code({ className, children }) {
          ...
          if (match) {
            ...
            const height = Math.max(120, Math.min(400, lineCount * 24 + 80)); // Dynamic height based on content
