...
export const NodeAsciidoc = ({ content }: NodeAsciidocProps) => {
  ...
  return (
    <div
      ref={containerRef}
      className="asciidoc-content prose prose-sm max-w-none dark:prose-invert
        ...
        [&_li]:mb-1
        [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:border-l-4 [&_blockquote]:border-gray-300 [&_blockquote]:mb-4 [&_blockquote]:text-gray-600
        [&_code]:px-1 [&_code]:py-0.5 [&_code]:bg-muted [&_code]:rounded [&_code]:text-sm [&_code]:font-mono
        [&_pre]:p-4 [&_pre]:bg-muted [&_pre]:rounded [&_pre]:overflow-x-auto [&_pre]:mb-4
        [&_table]:min-w-full [&_table]:divide-y [&_table]:divide-gray-200 [&_table]:border [&_table]:border-gray-300 [&_table]:mb-4
        [&_thead]:bg-gray-50
        [&_th]:px-6 [&_th]:py-3 [&_th]:text-left [&_th]:text-xs [&_th]:font-medium [&_th]:text-gray-500 [&_th]:uppercase [&_th]:tracking-wider
        [&_td]:px-6 [&_td]:py-4 [&_td]:whitespace-nowrap
        ...
        [&_.admonitionblock]:p-4 [&_.admonitionblock]:mb-4 [&_.admonitionblock]:rounded [&_.admonitionblock]:border-l-4
