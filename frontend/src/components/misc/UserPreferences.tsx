...
export const UserPreferencesDialog: FC<{
	isOpen: boolean;
	onClose: () => void;
}> = ({ isOpen, onClose }) => (
	<Modal isCentered isOpen={isOpen} onClose={onClose}>
		...
		<ModalContent minW="5xl" minH="50vh">
			...
			<ModalBody>
				<Tabs
					items={Object.entries(settingsTabs).map(
							...
							try {
								...
								if (skipped.length > 0)
									toast({
										status: "warning",
										description:
											"Some properties were skipped during import:\n" +
											skipped.join(", "),
									});
								else
									toast({
								...
								toast({
									status: "error",
									description:
										"Unable to import settings. See console for more information.",
								});
			...
			<Label text="Reset">
				<Flex gap={2} alignItems="center">
					...
					<span className="smallText">
						Clear all your user settings, resetting them to the default values
					</span>
				</Flex>
			</Label>
		</Flex>
