...
const autoRefresh = observable(
	{
		...
		scheduleNextRefresh() {
			this.nextRefresh =
				this.currentTime + uiSettings.autoRefreshIntervalSecs * 1000;
		},
	},
	undefined,
	{ autoBind: true },
					...
					content={
						<div>
							...
							<span className="codeBox">
								{uiSettings.autoRefreshIntervalSecs}s
							</span>
							.
						</div>
					}
					...
					<Popover
						...
						content={
							<div>
								...
								When switching pages, any data older than{" "}
								<span className="codeBox">
									{prettyMilliseconds(REST_CACHE_DURATION_SEC * 1000)}
								</span>{" "}
