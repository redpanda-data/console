          ...
          <Button className="h-8 border-dashed" size="sm" variant="outline">
            ...
            {selectedValues.size > 0 && (
              <>
                ...
                <Badge className="font-normal lg:hidden" size="sm" tone="neutral" variant="subtle">
                  {selectedValues.size}
                </Badge>
                <div className="hidden gap-1 lg:flex">
                  {selectedValues.size > 2 ? (
                    <Badge className="font-normal" size="sm" tone="neutral" variant="subtle">
                    ...
                    options
                      ...
                      .map((option) => (
                        <Badge className="font-normal" key={option.value} size="sm" tone="neutral" variant="subtle">
