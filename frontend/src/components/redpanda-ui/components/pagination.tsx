...
function Pagination({
	...
	testId,
	...props
}: React.ComponentProps<"nav"> & { testId?: string }) {
	return (
		<nav
...
function PaginationContent({
	...
	testId,
	...props
}: React.ComponentProps<"ul"> & { testId?: string }) {
	return (
		<ul
...
function PaginationEllipsis({
	...
	testId,
	...props
}: React.ComponentProps<"span"> & { testId?: string }) {
	return (
		<span
			aria-hidden
		...
		<Pagination className={className} testId={testId}>
			<PaginationContent>
				...
				{pages.map((page, index) => (
					<PaginationItem
						key={
							typeof page === "string" ? `ellipsis-${index}` : `page-${page}`
						}
					>
						{typeof page === "string" ? (
							<PaginationEllipsis />
