...
export const ServiceAccountDisplay = ({ serviceAccountId }: ServiceAccountDisplayProps) => {
  ...
  const {
    ...
    isLoading,
  } = useGetServiceAccountQuery(create(GetServiceAccountRequestSchema, { id: serviceAccountId }), {
  ...
  if (serviceAccountError) {
    ...
    return (
      <Alert variant="warning">
        ...
        <AlertDescription>Service account not found in Cloud API. It may have been deleted.</AlertDescription>
      </Alert>
    );
  }
