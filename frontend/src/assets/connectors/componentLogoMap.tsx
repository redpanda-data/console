...
export const componentLogoMap = {
  ...
  aws_dynamodb: AmazonWebServicesLogo,
  aws_dynamodb_partiql: AmazonWebServicesLogo,
  aws_kinesis: AmazonWebServicesLogo,
  aws_kinesis_firehose: AmazonWebServicesLogo,
  aws_lambda: AmazonWebServicesLogo,
  aws_s3: AmazonWebServicesLogo,
  aws_sns: AmazonWebServicesLogo,
  aws_sqs: AmazonWebServicesLogo,
  ...
  redpanda: RedpandaUILetterIcon,
  redpanda_common: RedpandaUILetterIcon,
  redpanda_data_transform: RedpandaUILetterIcon,
  redpanda_migrator: RedpandaUILetterIcon,
  redpanda_migrator_bundle: RedpandaUILetterIcon,
  redpanda_migrator_offsets: RedpandaUILetterIcon,
  reject: undefined,
