...
export const MemcachedLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg fill="currentColor" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g transform="matrix(.125052 0 0 .125052 .000001 56.523492)">
      <path
        d="M0-106.196v-179.82C0-431.255 20.725-452 165.814-452h180.164c145.084 0 165.8 20.745 165.8 165.983v179.82c0 145.238-20.725 165.983-165.812 165.983H165.812C20.73 59.787 0 39.042 0-106.196z"
        fill="url(#A)"
      />
      <path
      ...
      />
      <path
        d="M240.422-65.4c0 10.278-8.333 18.6-18.612 18.6s-18.6-8.333-18.6-18.6 8.333-18.612 18.6-18.612 18.612 8.332 18.612 18.612z"
        fill="url(#C)"
      />
      <path
        d="M308.66-65.4c0 10.278-8.332 18.6-18.6 18.6s-18.6-8.333-18.6-18.6 8.322-18.612 18.604-18.612 18.604 8.332 18.604 18.612z"
        fill="url(#D)"
      />
      <path
