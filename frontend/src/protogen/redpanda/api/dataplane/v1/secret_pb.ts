...
/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretsRequest
 */
export type ListResourcesBySecretsRequest = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretsRequest"> & {
  /**
   * @generated from field: redpanda.api.dataplane.v1.ListResourcesBySecretsRequest.Filter filter = 1;
   */
  filter?: ListResourcesBySecretsRequest_Filter;
};

/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretsRequest.
 * Use `create(ListResourcesBySecretsRequestSchema)` to create a new message.
 */
export const ListResourcesBySecretsRequestSchema: GenMessage<ListResourcesBySecretsRequest> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 24);

/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretsRequest.Filter
 */
export type ListResourcesBySecretsRequest_Filter = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretsRequest.Filter"> & {
  /**
   * @generated from field: repeated redpanda.api.dataplane.v1.Scope scope = 1;
   */
  scope: Scope[];

  /**
   * @generated from field: repeated string secret_id = 2;
   */
  secretId: string[];
};

/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretsRequest.Filter.
 * Use `create(ListResourcesBySecretsRequest_FilterSchema)` to create a new message.
 */
export const ListResourcesBySecretsRequest_FilterSchema: GenMessage<ListResourcesBySecretsRequest_Filter> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 24, 0);

/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretsResponse
 */
export type ListResourcesBySecretsResponse = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretsResponse"> & {
  /**
   * @generated from field: repeated redpanda.api.dataplane.v1.ResourcesForSecret resources_for_secret = 1;
   */
  resourcesForSecret: ResourcesForSecret[];
};

/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretsResponse.
 * Use `create(ListResourcesBySecretsResponseSchema)` to create a new message.
 */
export const ListResourcesBySecretsResponseSchema: GenMessage<ListResourcesBySecretsResponse> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 25);

/**
 * @generated from message redpanda.api.dataplane.v1.ResourcesForSecret
 */
export type ResourcesForSecret = Message<"redpanda.api.dataplane.v1.ResourcesForSecret"> & {
  /**
  ...
  /**
   * @generated from field: repeated redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType resources_for_type = 2;
   */
  resourcesForType: ResourcesForSecret_ResourcesForType[];
};

/**
 * Describes the message redpanda.api.dataplane.v1.ResourcesForSecret.
 * Use `create(ResourcesForSecretSchema)` to create a new message.
 */
export const ResourcesForSecretSchema: GenMessage<ResourcesForSecret> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 26);

/**
 * @generated from message redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType
 */
export type ResourcesForSecret_ResourcesForType = Message<"redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType"> & {
  /**
   * @generated from field: redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Type type = 1;
   */
  type: ResourcesForSecret_ResourcesForType_Type;

  /**
   * @generated from field: repeated redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Resource resource = 2;
   */
  resource: ResourcesForSecret_ResourcesForType_Resource[];
};

/**
 * Describes the message redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.
 * Use `create(ResourcesForSecret_ResourcesForTypeSchema)` to create a new message.
 */
export const ResourcesForSecret_ResourcesForTypeSchema: GenMessage<ResourcesForSecret_ResourcesForType> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 26, 0);

/**
 * @generated from message redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Resource
 */
export type ResourcesForSecret_ResourcesForType_Resource = Message<"redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Resource"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
...
/**
 * Describes the message redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Resource.
 * Use `create(ResourcesForSecret_ResourcesForType_ResourceSchema)` to create a new message.
 */
export const ResourcesForSecret_ResourcesForType_ResourceSchema: GenMessage<ResourcesForSecret_ResourcesForType_Resource> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 26, 0, 0);

/**
 * @generated from enum redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Type
 */
export enum ResourcesForSecret_ResourcesForType_Type {
  /**
  ...
  /**
   * @generated from enum value: TYPE_PIPELINE = 1;
   */
  PIPELINE = 1,

  /**
   * @generated from enum value: TYPE_CLUSTER = 2;
   */
  CLUSTER = 2,

  /**
   * @generated from enum value: TYPE_MCP_SERVER = 3;
   */
  MCP_SERVER = 3,

  /**
   * @generated from enum value: TYPE_AI_AGENT = 4;
   */
  AI_AGENT = 4,
}

/**
 * Describes the enum redpanda.api.dataplane.v1.ResourcesForSecret.ResourcesForType.Type.
 */
export const ResourcesForSecret_ResourcesForType_TypeSchema: GenEnum<ResourcesForSecret_ResourcesForType_Type> = /*@__PURE__*/
  enumDesc(file_redpanda_api_dataplane_v1_secret, 26, 0, 0);
...
export const SecretService: GenService<{
   ...
   *
   * @generated from rpc redpanda.api.dataplane.v1.SecretService.ListResourcesBySecrets
   */
  listResourcesBySecrets: {
    methodKind: "unary";
    input: typeof ListResourcesBySecretsRequestSchema;
    output: typeof ListResourcesBySecretsResponseSchema;
  },
}> = /*@__PURE__*/
