...
/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretRequest
 */
export type ListResourcesBySecretRequest = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretRequest"> & {
  /**
   * @generated from field: redpanda.api.dataplane.v1.ListResourcesBySecretRequest.Filter filter = 1;
   */
  filter?: ListResourcesBySecretRequest_Filter;
};

/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretRequest.
 * Use `create(ListResourcesBySecretRequestSchema)` to create a new message.
 */
export const ListResourcesBySecretRequestSchema: GenMessage<ListResourcesBySecretRequest> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 24);

/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretRequest.Filter
 */
export type ListResourcesBySecretRequest_Filter = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretRequest.Filter"> & {
  /**
...
/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretRequest.Filter.
 * Use `create(ListResourcesBySecretRequest_FilterSchema)` to create a new message.
 */
export const ListResourcesBySecretRequest_FilterSchema: GenMessage<ListResourcesBySecretRequest_Filter> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 24, 0);

/**
 * @generated from message redpanda.api.dataplane.v1.ListResourcesBySecretResponse
 */
export type ListResourcesBySecretResponse = Message<"redpanda.api.dataplane.v1.ListResourcesBySecretResponse"> & {
  /**
...
/**
 * Describes the message redpanda.api.dataplane.v1.ListResourcesBySecretResponse.
 * Use `create(ListResourcesBySecretResponseSchema)` to create a new message.
 */
export const ListResourcesBySecretResponseSchema: GenMessage<ListResourcesBySecretResponse> = /*@__PURE__*/
...
export type ResourcesForSecret = Message<"redpanda.api.dataplane.v1.ResourcesForSecret"> & {
  ...
  /**
   * @generated from field: repeated redpanda.api.dataplane.v1.ResourcesForSecret.Resource resource = 2;
   */
  resource: ResourcesForSecret_Resource[];
};
...
/**
 * @generated from message redpanda.api.dataplane.v1.ResourcesForSecret.Resource
 */
export type ResourcesForSecret_Resource = Message<"redpanda.api.dataplane.v1.ResourcesForSecret.Resource"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
  ...
  /**
   * @generated from field: redpanda.api.dataplane.v1.ResourcesForSecret.Type type = 2;
   */
  type: ResourcesForSecret_Type;
...
/**
 * Describes the message redpanda.api.dataplane.v1.ResourcesForSecret.Resource.
 * Use `create(ResourcesForSecret_ResourceSchema)` to create a new message.
 */
export const ResourcesForSecret_ResourceSchema: GenMessage<ResourcesForSecret_Resource> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_secret, 26, 0);

/**
 * @generated from enum redpanda.api.dataplane.v1.ResourcesForSecret.Type
 */
export enum ResourcesForSecret_Type {
  /**
...
/**
 * Describes the enum redpanda.api.dataplane.v1.ResourcesForSecret.Type.
 */
export const ResourcesForSecret_TypeSchema: GenEnum<ResourcesForSecret_Type> = /*@__PURE__*/
  enumDesc(file_redpanda_api_dataplane_v1_secret, 26, 0);
...
export const SecretService: GenService<{
   ...
   *
   * @generated from rpc redpanda.api.dataplane.v1.SecretService.ListResourcesBySecret
   */
  listResourcesBySecret: {
    methodKind: "unary";
    input: typeof ListResourcesBySecretRequestSchema;
    output: typeof ListResourcesBySecretResponseSchema;
  },
}> = /*@__PURE__*/
