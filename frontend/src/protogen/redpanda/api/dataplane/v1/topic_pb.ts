...
export type ListTopicsResponse_Topic = Message<"redpanda.api.dataplane.v1.ListTopicsResponse.Topic"> & {
   ...
   *
   * @generated from field: redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary log_dir_summary = 6;
   */
...
export type ListTopicsResponse_Topic_LogDirSummary = Message<"redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary"> & {
   ...
   *
   * @generated from field: repeated redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary.ReplicaError replica_errors = 3;
   */
  replicaErrors: ListTopicsResponse_Topic_LogDirSummary_ReplicaError[];
};
 ...
 *
 * @generated from message redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary.ReplicaError
 */
export type ListTopicsResponse_Topic_LogDirSummary_ReplicaError = Message<"redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary.ReplicaError"> & {
  /**
...
/**
 * Describes the message redpanda.api.dataplane.v1.ListTopicsResponse.Topic.LogDirSummary.ReplicaError.
 * Use `create(ListTopicsResponse_Topic_LogDirSummary_ReplicaErrorSchema)` to create a new message.
 */
export const ListTopicsResponse_Topic_LogDirSummary_ReplicaErrorSchema: GenMessage<ListTopicsResponse_Topic_LogDirSummary_ReplicaError> = /*@__PURE__*/
  messageDesc(file_redpanda_api_dataplane_v1_topic, 4, 0, 0, 0);
