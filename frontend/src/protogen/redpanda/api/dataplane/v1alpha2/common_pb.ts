...
proto3.util.setEnumType(
	ConfigSource,
	"redpanda.api.dataplane.v1alpha2.ConfigSource",
	[
...
proto3.util.setEnumType(
	ConfigType,
	"redpanda.api.dataplane.v1alpha2.ConfigType",
	[
...
proto3.util.setEnumType(
	...
	"redpanda.api.dataplane.v1alpha2.ConfigAlterOperation",
	[
...
export class ConfigSynonym extends Message<ConfigSynonym> {
	...
	static readonly typeName = "redpanda.api.dataplane.v1alpha2.ConfigSynonym";
	...
	static equals(
		a: ConfigSynonym | PlainMessage<ConfigSynonym> | undefined,
		b: ConfigSynonym | PlainMessage<ConfigSynonym> | undefined,
	): boolean {
