...
export type AIAgent = Message<"redpanda.api.dataplane.v1alpha3.AIAgent"> & {
   ...
   *
   * @generated from field: optional string teams_bridge_endpoint = 19;
   */
  teamsBridgeEndpoint?: string;
};
