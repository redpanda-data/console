...
export type AIAgent_Provider = Message<"redpanda.api.dataplane.v1alpha3.AIAgent.Provider"> & {
  ...
  provider: {
    ...
    /**
     * @generated from field: redpanda.api.dataplane.v1alpha3.AIAgent.Provider.Gemini gemini = 3;
     */
    value: AIAgent_Provider_Gemini;
    case: "gemini";
  } | {
    /**
...
/**
 * @generated from message redpanda.api.dataplane.v1alpha3.AIAgent.Provider.Gemini
 */
export type AIAgent_Provider_Gemini = Message<"redpanda.api.dataplane.v1alpha3.AIAgent.Provider.Gemini"> & {
  /**
   * @generated from field: string api_key = 1;
   */
  apiKey: string;
...
/**
 * Describes the message redpanda.api.dataplane.v1alpha3.AIAgent.Provider.Gemini.
 * Use `create(AIAgent_Provider_GeminiSchema)` to create a new message.
 */
export const AIAgent_Provider_GeminiSchema: GenMessage<AIAgent_Provider_Gemini> = /*@__PURE__*/
