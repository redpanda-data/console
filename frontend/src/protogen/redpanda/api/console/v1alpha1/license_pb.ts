...
export class License extends Message<License> {
	...
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			...
			name: "source",
			kind: "enum",
			T: proto3.getEnumType(License_Source),
		},
	...
	static equals(
		a: License | PlainMessage<License> | undefined,
		b: License | PlainMessage<License> | undefined,
	): boolean {
...
proto3.util.setEnumType(
	License_Source,
	"redpanda.api.console.v1alpha1.License.Source",
	[
...
proto3.util.setEnumType(
	License_Type,
	"redpanda.api.console.v1alpha1.License.Type",
	[
...
export class ListLicensesRequest extends Message<ListLicensesRequest> {
	...
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListLicensesRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => []);
	...
	static equals(
		a: ListLicensesRequest | PlainMessage<ListLicensesRequest> | undefined,
		b: ListLicensesRequest | PlainMessage<ListLicensesRequest> | undefined,
	): boolean {
...
export class ListLicensesResponse extends Message<ListLicensesResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListLicensesResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static equals(
		a: ListLicensesResponse | PlainMessage<ListLicensesResponse> | undefined,
		b: ListLicensesResponse | PlainMessage<ListLicensesResponse> | undefined,
	): boolean {
...
export class SetLicenseRequest extends Message<SetLicenseRequest> {
	...
	static equals(
		a: SetLicenseRequest | PlainMessage<SetLicenseRequest> | undefined,
		b: SetLicenseRequest | PlainMessage<SetLicenseRequest> | undefined,
	): boolean {
...
export class SetLicenseResponse extends Message<SetLicenseResponse> {
	...
	static equals(
		a: SetLicenseResponse | PlainMessage<SetLicenseResponse> | undefined,
		b: SetLicenseResponse | PlainMessage<SetLicenseResponse> | undefined,
	): boolean {
...
export class ListEnterpriseFeaturesRequest extends Message<ListEnterpriseFeaturesRequest> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListEnterpriseFeaturesRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => []);

	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListEnterpriseFeaturesRequest {
	...
	static fromJsonString(
		...
		return new ListEnterpriseFeaturesRequest().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListEnterpriseFeaturesRequest
			| PlainMessage<ListEnterpriseFeaturesRequest>
			| undefined,
		b:
			| ListEnterpriseFeaturesRequest
			| PlainMessage<ListEnterpriseFeaturesRequest>
...
export class ListEnterpriseFeaturesResponse extends Message<ListEnterpriseFeaturesResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListEnterpriseFeaturesResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "license_status",
			kind: "enum",
			T: proto3.getEnumType(ListEnterpriseFeaturesResponse_LicenseStatus),
		},
		{ no: 2, name: "violation", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
		{
			no: 3,
			name: "features",
			kind: "message",
			T: ListEnterpriseFeaturesResponse_Feature,
			repeated: true,
		},
	]);
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListEnterpriseFeaturesResponse {
	...
	static fromJsonString(
		...
		return new ListEnterpriseFeaturesResponse().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListEnterpriseFeaturesResponse
			| PlainMessage<ListEnterpriseFeaturesResponse>
			| undefined,
		b:
			| ListEnterpriseFeaturesResponse
			| PlainMessage<ListEnterpriseFeaturesResponse>
...
proto3.util.setEnumType(
	ListEnterpriseFeaturesResponse_LicenseStatus,
	"redpanda.api.console.v1alpha1.ListEnterpriseFeaturesResponse.LicenseStatus",
	[
...
export class ListEnterpriseFeaturesResponse_Feature extends Message<ListEnterpriseFeaturesResponse_Feature> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListEnterpriseFeaturesResponse.Feature";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static fromBinary(
		...
		return new ListEnterpriseFeaturesResponse_Feature().fromBinary(
			bytes,
			options,
		);
	}
	...
	static fromJson(
		...
		return new ListEnterpriseFeaturesResponse_Feature().fromJson(
			jsonValue,
			options,
		);
	}
	...
	static fromJsonString(
		...
		return new ListEnterpriseFeaturesResponse_Feature().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListEnterpriseFeaturesResponse_Feature
			| PlainMessage<ListEnterpriseFeaturesResponse_Feature>
			| undefined,
		b:
			| ListEnterpriseFeaturesResponse_Feature
			| PlainMessage<ListEnterpriseFeaturesResponse_Feature>
