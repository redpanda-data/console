...
export class LintConfigRequest extends Message<LintConfigRequest> {
	...
	static equals(
		a: LintConfigRequest | PlainMessage<LintConfigRequest> | undefined,
		b: LintConfigRequest | PlainMessage<LintConfigRequest> | undefined,
	): boolean {
...
export class LintConfigResponse extends Message<LintConfigResponse> {
	...
	static equals(
		a: LintConfigResponse | PlainMessage<LintConfigResponse> | undefined,
		b: LintConfigResponse | PlainMessage<LintConfigResponse> | undefined,
	): boolean {
...
export class LintConfigResponse_Lint extends Message<LintConfigResponse_Lint> {
	...
	static readonly typeName =
		"redpanda.api.console.v1alpha1.LintConfigResponse.Lint";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static equals(
		a:
			| LintConfigResponse_Lint
			| PlainMessage<LintConfigResponse_Lint>
			| undefined,
		b:
			| LintConfigResponse_Lint
			| PlainMessage<LintConfigResponse_Lint>
