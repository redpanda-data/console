...
export class ListMessagesRequest extends Message<ListMessagesRequest> {
	...
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		...
		{
			no: 9,
			name: "include_original_raw_payload",
			kind: "scalar",
			T: 8 /* ScalarType.BOOL */,
		},
		{
			...
			kind: "enum",
			T: proto3.getEnumType(PayloadEncoding),
			opt: true,
		},
		{
			no: 11,
...
export class ListMessagesResponse extends Message<ListMessagesResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "data",
			kind: "message",
			T: ListMessagesResponse_DataMessage,
		...
		},
		{
			...
			name: "phase",
			kind: "message",
			T: ListMessagesResponse_PhaseMessage,
			oneof: "control_message",
		},
		{
			no: 3,
			name: "progress",
			kind: "message",
			T: ListMessagesResponse_ProgressMessage,
			oneof: "control_message",
		},
		{
			no: 4,
			name: "done",
			kind: "message",
			T: ListMessagesResponse_StreamCompletedMessage,
			oneof: "control_message",
		},
		{
			no: 5,
			name: "error",
			kind: "message",
			T: ListMessagesResponse_ErrorMessage,
			oneof: "control_message",
		},
	]);
...
export class ListMessagesResponse_DataMessage extends Message<ListMessagesResponse_DataMessage> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse.DataMessage";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "partition_id",
		...
		{ no: 3, name: "timestamp", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
		{
			...
			name: "compression",
			kind: "enum",
			T: proto3.getEnumType(CompressionType),
		},
		{
			no: 5,
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListMessagesResponse_DataMessage {
	...
	static fromJsonString(
		...
		return new ListMessagesResponse_DataMessage().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListMessagesResponse_DataMessage
			| PlainMessage<ListMessagesResponse_DataMessage>
			| undefined,
		b:
			| ListMessagesResponse_DataMessage
			| PlainMessage<ListMessagesResponse_DataMessage>
...
export class ListMessagesResponse_PhaseMessage extends Message<ListMessagesResponse_PhaseMessage> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse.PhaseMessage";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListMessagesResponse_PhaseMessage {
	...
	static fromJsonString(
		...
		return new ListMessagesResponse_PhaseMessage().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListMessagesResponse_PhaseMessage
			| PlainMessage<ListMessagesResponse_PhaseMessage>
			| undefined,
		b:
			| ListMessagesResponse_PhaseMessage
			| PlainMessage<ListMessagesResponse_PhaseMessage>
...
export class ListMessagesResponse_ProgressMessage extends Message<ListMessagesResponse_ProgressMessage> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse.ProgressMessage";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListMessagesResponse_ProgressMessage {
		return new ListMessagesResponse_ProgressMessage().fromBinary(
			bytes,
			options,
		);
	}
	...
	static fromJson(
		...
		return new ListMessagesResponse_ProgressMessage().fromJson(
			jsonValue,
			options,
		);
	}
	...
	static fromJsonString(
		...
		return new ListMessagesResponse_ProgressMessage().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListMessagesResponse_ProgressMessage
			| PlainMessage<ListMessagesResponse_ProgressMessage>
			| undefined,
		b:
			| ListMessagesResponse_ProgressMessage
			| PlainMessage<ListMessagesResponse_ProgressMessage>
...
export class ListMessagesResponse_StreamCompletedMessage extends Message<ListMessagesResponse_StreamCompletedMessage> {
	...
	constructor(
		data?: PartialMessage<ListMessagesResponse_StreamCompletedMessage>,
	) {
		super();
		proto3.util.initPartial(data, this);
	}
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse.StreamCompletedMessage";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListMessagesResponse_StreamCompletedMessage {
		return new ListMessagesResponse_StreamCompletedMessage().fromBinary(
			bytes,
			options,
		);
	}
	...
	static fromJson(
		...
		return new ListMessagesResponse_StreamCompletedMessage().fromJson(
			jsonValue,
			options,
		);
	}
	...
	static fromJsonString(
		...
		return new ListMessagesResponse_StreamCompletedMessage().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListMessagesResponse_StreamCompletedMessage
			| PlainMessage<ListMessagesResponse_StreamCompletedMessage>
			| undefined,
		b:
			| ListMessagesResponse_StreamCompletedMessage
			| PlainMessage<ListMessagesResponse_StreamCompletedMessage>
...
export class ListMessagesResponse_ErrorMessage extends Message<ListMessagesResponse_ErrorMessage> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.ListMessagesResponse.ErrorMessage";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): ListMessagesResponse_ErrorMessage {
	...
	static fromJsonString(
		...
		return new ListMessagesResponse_ErrorMessage().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| ListMessagesResponse_ErrorMessage
			| PlainMessage<ListMessagesResponse_ErrorMessage>
			| undefined,
		b:
			| ListMessagesResponse_ErrorMessage
			| PlainMessage<ListMessagesResponse_ErrorMessage>
...
export class KafkaRecordPayload extends Message<KafkaRecordPayload> {
	...
	static equals(
		a: KafkaRecordPayload | PlainMessage<KafkaRecordPayload> | undefined,
		b: KafkaRecordPayload | PlainMessage<KafkaRecordPayload> | undefined,
	): boolean {
