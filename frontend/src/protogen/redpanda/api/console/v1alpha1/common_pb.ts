...
proto3.util.setEnumType(
	CompressionType,
	"redpanda.api.console.v1alpha1.CompressionType",
	[
...
proto3.util.setEnumType(
	PayloadEncoding,
	"redpanda.api.console.v1alpha1.PayloadEncoding",
	[
...
export class KafkaRecordHeader extends Message<KafkaRecordHeader> {
	...
	static equals(
		a: KafkaRecordHeader | PlainMessage<KafkaRecordHeader> | undefined,
		b: KafkaRecordHeader | PlainMessage<KafkaRecordHeader> | undefined,
	): boolean {
...
export class TroubleshootReport extends Message<TroubleshootReport> {
	...
	static equals(
		a: TroubleshootReport | PlainMessage<TroubleshootReport> | undefined,
		b: TroubleshootReport | PlainMessage<TroubleshootReport> | undefined,
	): boolean {
