...
export class PublishMessageRequest extends Message<PublishMessageRequest> {
	...
	static readonly typeName =
		"redpanda.api.console.v1alpha1.PublishMessageRequest";
	...
	static equals(
		a: PublishMessageRequest | PlainMessage<PublishMessageRequest> | undefined,
		b: PublishMessageRequest | PlainMessage<PublishMessageRequest> | undefined,
	): boolean {
...
export class PublishMessagePayloadOptions extends Message<PublishMessagePayloadOptions> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.PublishMessagePayloadOptions";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "encoding",
	...
	static fromJsonString(
		...
		return new PublishMessagePayloadOptions().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| PublishMessagePayloadOptions
			| PlainMessage<PublishMessagePayloadOptions>
			| undefined,
		b:
			| PublishMessagePayloadOptions
			| PlainMessage<PublishMessagePayloadOptions>
...
export class PublishMessageResponse extends Message<PublishMessageResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.PublishMessageResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "topic", kind: "scalar", T: 9 /* ScalarType.STRING */ },
		{
			no: 2,
	...
	static equals(
		a:
			| PublishMessageResponse
			| PlainMessage<PublishMessageResponse>
			| undefined,
		b:
			| PublishMessageResponse
			| PlainMessage<PublishMessageResponse>
