...
proto3.util.setEnumType(
	BundleErrorCode,
	"redpanda.api.console.v1alpha1.BundleErrorCode",
	[
...
proto3.util.setEnumType(
	UnhealthyReason,
	"redpanda.api.console.v1alpha1.UnhealthyReason",
	[
...
export class SCRAMAuth extends Message<SCRAMAuth> {
	...
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		...
		{ no: 2, name: "password", kind: "scalar", T: 9 /* ScalarType.STRING */ },
		{
			...
			name: "mechanism",
			kind: "enum",
			T: proto3.getEnumType(SCRAMAuth_Mechanism),
		},
	]);
	...
	static equals(
		a: SCRAMAuth | PlainMessage<SCRAMAuth> | undefined,
		b: SCRAMAuth | PlainMessage<SCRAMAuth> | undefined,
	): boolean {
...
proto3.util.setEnumType(
	SCRAMAuth_Mechanism,
	"redpanda.api.console.v1alpha1.SCRAMAuth.Mechanism",
	[
...
export class CreateDebugBundleRequest extends Message<CreateDebugBundleRequest> {
	...
	static readonly typeName =
		"redpanda.api.console.v1alpha1.CreateDebugBundleRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "scram",
		...
		{
			no: 4,
			name: "controller_logs_size_limit_bytes",
			kind: "scalar",
			T: 5 /* ScalarType.INT32 */,
		},
		{
			no: 5,
			name: "cpu_profiler_wait_seconds",
			kind: "scalar",
			T: 5 /* ScalarType.INT32 */,
			opt: true,
		},
	...
	static equals(
		a:
			| CreateDebugBundleRequest
			| PlainMessage<CreateDebugBundleRequest>
			| undefined,
		b:
			| CreateDebugBundleRequest
			| PlainMessage<CreateDebugBundleRequest>
...
export class LabelSelector extends Message<LabelSelector> {
	...
	static equals(
		a: LabelSelector | PlainMessage<LabelSelector> | undefined,
		b: LabelSelector | PlainMessage<LabelSelector> | undefined,
	): boolean {
...
export class CreateDebugBundleResponse extends Message<CreateDebugBundleResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.CreateDebugBundleResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static equals(
		a:
			| CreateDebugBundleResponse
			| PlainMessage<CreateDebugBundleResponse>
			| undefined,
		b:
			| CreateDebugBundleResponse
			| PlainMessage<CreateDebugBundleResponse>
...
export class GetDebugBundleStatusRequest extends Message<GetDebugBundleStatusRequest> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.GetDebugBundleStatusRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "broker_ids",
	...
	static fromJsonString(
		...
		return new GetDebugBundleStatusRequest().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| GetDebugBundleStatusRequest
			| PlainMessage<GetDebugBundleStatusRequest>
			| undefined,
		b:
			| GetDebugBundleStatusRequest
			| PlainMessage<GetDebugBundleStatusRequest>
...
export class DebugBundleStatus extends Message<DebugBundleStatus> {
	...
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		...
		{ no: 2, name: "job_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
		{
			...
			name: "status",
			kind: "enum",
			T: proto3.getEnumType(DebugBundleStatus_Status),
		},
	...
	static equals(
		a: DebugBundleStatus | PlainMessage<DebugBundleStatus> | undefined,
		b: DebugBundleStatus | PlainMessage<DebugBundleStatus> | undefined,
	): boolean {
...
proto3.util.setEnumType(
	...
	"redpanda.api.console.v1alpha1.DebugBundleStatus.Status",
	[
...
export class GetDebugBundleStatusResponse extends Message<GetDebugBundleStatusResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.GetDebugBundleStatusResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{
			no: 1,
			name: "broker_statuses",
			kind: "message",
			T: GetDebugBundleStatusResponse_DebugBundleBrokerStatus,
			repeated: true,
		},
		{
			no: 2,
			name: "has_debug_process",
			kind: "scalar",
			T: 8 /* ScalarType.BOOL */,
		},
	]);
	...
	static fromJsonString(
		...
		return new GetDebugBundleStatusResponse().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| GetDebugBundleStatusResponse
			| PlainMessage<GetDebugBundleStatusResponse>
			| undefined,
		b:
			| GetDebugBundleStatusResponse
			| PlainMessage<GetDebugBundleStatusResponse>
...
export class GetDebugBundleStatusResponse_DebugBundleBrokerStatus extends Message<GetDebugBundleStatusResponse_DebugBundleBrokerStatus> {
	...
	constructor(
		data?: PartialMessage<GetDebugBundleStatusResponse_DebugBundleBrokerStatus>,
	) {
		super();
		proto3.util.initPartial(data, this);
	}
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.GetDebugBundleStatusResponse.DebugBundleBrokerStatus";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "broker_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
	...
	static fromBinary(
		...
		return new GetDebugBundleStatusResponse_DebugBundleBrokerStatus().fromBinary(
			bytes,
			options,
		);
	}
	...
	static fromJson(
		...
		return new GetDebugBundleStatusResponse_DebugBundleBrokerStatus().fromJson(
			jsonValue,
			options,
		);
	}
	...
	static fromJsonString(
		...
		return new GetDebugBundleStatusResponse_DebugBundleBrokerStatus().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| GetDebugBundleStatusResponse_DebugBundleBrokerStatus
			| PlainMessage<GetDebugBundleStatusResponse_DebugBundleBrokerStatus>
			| undefined,
		b:
			| GetDebugBundleStatusResponse_DebugBundleBrokerStatus
			| PlainMessage<GetDebugBundleStatusResponse_DebugBundleBrokerStatus>
...
export class CancelDebugBundleProcessRequest extends Message<CancelDebugBundleProcessRequest> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.CancelDebugBundleProcessRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "job_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
		{
			no: 2,
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): CancelDebugBundleProcessRequest {
	...
	static fromJsonString(
		...
		return new CancelDebugBundleProcessRequest().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| CancelDebugBundleProcessRequest
			| PlainMessage<CancelDebugBundleProcessRequest>
			| undefined,
		b:
			| CancelDebugBundleProcessRequest
			| PlainMessage<CancelDebugBundleProcessRequest>
...
export class CancelDebugBundleProcessResponse extends Message<CancelDebugBundleProcessResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.CancelDebugBundleProcessResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
	...
	static fromJsonString(
		...
		return new CancelDebugBundleProcessResponse().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| CancelDebugBundleProcessResponse
			| PlainMessage<CancelDebugBundleProcessResponse>
			| undefined,
		b:
			| CancelDebugBundleProcessResponse
			| PlainMessage<CancelDebugBundleProcessResponse>
...
export class DeleteDebugBundleFileRequest extends Message<DeleteDebugBundleFileRequest> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.DeleteDebugBundleFileRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "delete_all", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
		{
			...
			name: "files",
			kind: "message",
			T: DeleteDebugBundleFileForBroker,
			repeated: true,
		},
	]);
	...
	static fromJsonString(
		...
		return new DeleteDebugBundleFileRequest().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| DeleteDebugBundleFileRequest
			| PlainMessage<DeleteDebugBundleFileRequest>
			| undefined,
		b:
			| DeleteDebugBundleFileRequest
			| PlainMessage<DeleteDebugBundleFileRequest>
...
export class DeleteDebugBundleFileForBroker extends Message<DeleteDebugBundleFileForBroker> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.DeleteDebugBundleFileForBroker";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "broker_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
	...
	static fromBinary(
		bytes: Uint8Array,
		options?: Partial<BinaryReadOptions>,
	): DeleteDebugBundleFileForBroker {
	...
	static fromJsonString(
		...
		return new DeleteDebugBundleFileForBroker().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| DeleteDebugBundleFileForBroker
			| PlainMessage<DeleteDebugBundleFileForBroker>
			| undefined,
		b:
			| DeleteDebugBundleFileForBroker
			| PlainMessage<DeleteDebugBundleFileForBroker>
...
export class DeleteDebugBundleFileResponse extends Message<DeleteDebugBundleFileResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.DeleteDebugBundleFileResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "errors", kind: "message", T: BundleError, repeated: true },
	]);
	...
	static fromJsonString(
		...
		return new DeleteDebugBundleFileResponse().fromJsonString(
			jsonString,
			options,
		);
	}
	...
	static equals(
		a:
			| DeleteDebugBundleFileResponse
			| PlainMessage<DeleteDebugBundleFileResponse>
			| undefined,
		b:
			| DeleteDebugBundleFileResponse
			| PlainMessage<DeleteDebugBundleFileResponse>
...
export class BundleError extends Message<BundleError> {
	...
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		...
		{ no: 3, name: "speculative", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
		{
			...
			name: "code",
			kind: "enum",
			T: proto3.getEnumType(BundleErrorCode),
		},
	...
	static equals(
		a: BundleError | PlainMessage<BundleError> | undefined,
		b: BundleError | PlainMessage<BundleError> | undefined,
	): boolean {
...
export class GetClusterHealthRequest extends Message<GetClusterHealthRequest> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.GetClusterHealthRequest";
	static readonly fields: FieldList = proto3.util.newFieldList(() => []);
	...
	static equals(
		a:
			| GetClusterHealthRequest
			| PlainMessage<GetClusterHealthRequest>
			| undefined,
		b:
			| GetClusterHealthRequest
			| PlainMessage<GetClusterHealthRequest>
...
export class GetClusterHealthResponse extends Message<GetClusterHealthResponse> {
	...
	static readonly runtime: typeof proto3 = proto3;
	static readonly typeName =
		"redpanda.api.console.v1alpha1.GetClusterHealthResponse";
	static readonly fields: FieldList = proto3.util.newFieldList(() => [
		{ no: 1, name: "is_healthy", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
		{
			no: 2,
			name: "unhealthy_reasons",
			kind: "enum",
			T: proto3.getEnumType(UnhealthyReason),
			repeated: true,
		},
		{
			no: 3,
		...
		{
			no: 6,
			name: "broker_ids_in_recovery_mode",
			kind: "scalar",
			T: 5 /* ScalarType.INT32 */,
			repeated: true,
		},
		{
			no: 7,
			name: "leaderless_partitions_count",
			kind: "scalar",
			T: 5 /* ScalarType.INT32 */,
		},
		{
			no: 8,
			name: "leaderless_partitions",
			kind: "message",
			T: TopicPartitions,
			repeated: true,
		},
		{
			no: 9,
			name: "under_replicated_partitions_count",
			kind: "scalar",
			T: 5 /* ScalarType.INT32 */,
		},
		{
	...
	static equals(
		a:
			| GetClusterHealthResponse
			| PlainMessage<GetClusterHealthResponse>
			| undefined,
		b:
			| GetClusterHealthResponse
			| PlainMessage<GetClusterHealthResponse>
...
export class TopicPartitions extends Message<TopicPartitions> {
	...
	static equals(
		a: TopicPartitions | PlainMessage<TopicPartitions> | undefined,
		b: TopicPartitions | PlainMessage<TopicPartitions> | undefined,
	): boolean {
