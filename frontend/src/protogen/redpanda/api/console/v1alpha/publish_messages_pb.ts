...
// @generated from file redpanda/api/console/v1alpha/publish_messages.proto (package redpanda.api.console.v1alpha, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message redpanda.api.console.v1alpha.PublishMessageRequest
 */
export class PublishMessageRequest extends Message<PublishMessageRequest> {
   ...
   *
   * @generated from field: redpanda.api.console.v1alpha.CompressionType compression = 3;
   */
   ...
   *
   * @generated from field: repeated redpanda.api.console.v1alpha.KafkaRecordHeader headers = 5;
   */
  headers: KafkaRecordHeader[] = [];

  /**
   * @generated from field: redpanda.api.console.v1alpha.PublishMessagePayloadOptions key = 6;
   */
  key?: PublishMessagePayloadOptions;

  /**
   * @generated from field: redpanda.api.console.v1alpha.PublishMessagePayloadOptions value = 7;
   */
  ...
  static readonly typeName = "redpanda.api.console.v1alpha.PublishMessageRequest";
...
/**
 * @generated from message redpanda.api.console.v1alpha.PublishMessagePayloadOptions
 */
export class PublishMessagePayloadOptions extends Message<PublishMessagePayloadOptions> {
  /**
   * Payload encoding to use.
   *
   * @generated from field: redpanda.api.console.v1alpha.PayloadEncoding encoding = 1;
   */
 ...
 *
 * @generated from message redpanda.api.console.v1alpha.PublishMessageResponse
 */
export class PublishMessageResponse extends Message<PublishMessageResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.console.v1alpha.PublishMessageResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "topic", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "partition_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
