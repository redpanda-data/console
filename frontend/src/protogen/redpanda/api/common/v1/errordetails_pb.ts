...
export class AttemptInfo extends Message<AttemptInfo> {
	...
	static equals(
		a: AttemptInfo | PlainMessage<AttemptInfo> | undefined,
		b: AttemptInfo | PlainMessage<AttemptInfo> | undefined,
	): boolean {
...
export class AttemptInfo_Attempt extends Message<AttemptInfo_Attempt> {
	...
	static equals(
		a: AttemptInfo_Attempt | PlainMessage<AttemptInfo_Attempt> | undefined,
		b: AttemptInfo_Attempt | PlainMessage<AttemptInfo_Attempt> | undefined,
	): boolean {
...
export class ExternalError extends Message<ExternalError> {
	...
	static equals(
		a: ExternalError | PlainMessage<ExternalError> | undefined,
		b: ExternalError | PlainMessage<ExternalError> | undefined,
	): boolean {
