...
export const MotionDiv: FC<{ identityKey?: any, positionTransition?: boolean, layoutTransition?: boolean, style?: CSSProperties }> = (p) => <motion.div {...animProps} positionTransition={p.positionTransition} layoutTransition={p.layoutTransition} key={p.identityKey} style={p.style}>{p.children}</motion.div>;
