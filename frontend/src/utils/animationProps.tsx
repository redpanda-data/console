...
export const MotionDiv: FC<{ identityKey?: any, positionTransition?: boolean, style?: CSSProperties }> = (p) => <motion.div {...animProps} positionTransition={p.positionTransition} key={p.identityKey} style={p.style}>{p.children}</motion.div>;
