...
export default (
	<svg viewBox="0 0 260 260" focusable={false}>
		<g
			transform="translate(0,260) scale(0.100000,-0.100000)"
			fill="currentColor"
			stroke="none"
		>
			<path
...
129 56 38 1 74 5 80 9 6 4 10 26 9 49 l-2 43 -90 1 c-49 1 -100 0 -113 -3z"
			/>
			<path
				d="M2087 2393 c-3 -7 -2 -45 2 -86 1 -9 23 -13 76 -14 80 -1 114 -15
...
61 -86 139 -138 149 -46 9 -189 9 -194 0z"
			/>
			<path
				d="M1240 2029 c-184 -16 -344 -91 -468 -218 -137 -140 -213 -324 -213
