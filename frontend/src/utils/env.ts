...
const isDev =
	...
	process.env.REACT_APP_DEV_HINT;
export const IsProd = !isDev;
export const IsDev = isDev;
export const IsCI =
	env.REACT_APP_BUILT_FROM_PUSH && env.REACT_APP_BUILT_FROM_PUSH != "false";
...
const basePath =
	typeof basePathRaw === "string" && !basePathRaw.startsWith("__BASE_PATH")
		? basePathRaw
		: "";
